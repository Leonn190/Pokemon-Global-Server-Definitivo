...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_kptb1zip`  
**Gerado em:** 2026-05-15T09:41:45  
...
- **Pastas:** 1.129
- **Arquivos:** 67.786
- **Arquivos de texto:** 90
- **Peso dos arquivos de texto:** 221.65 KB
- **Tamanho total:** 0.328 GB (351.923.501 bytes)
- **Dias desde a criação do projeto:** 1
- **Dias desde a criação oficial:** 275
- **Horas estimadas:** 38.00
- **Linhas totais gerais:** 6.512
- **Commits (projeto):** 33
...
- **Arquivos `.py`:** 82
- **Linhas totais:** 6.512
- **Tamanho total `.py`:** 221.65 KB
- **Classes encontradas:** 16
- **Funções encontradas:** 226
- **Métodos encontrados:** 90
- **Total funções + métodos:** 316
- **Bibliotecas diferentes usadas:** 25

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-03-03_22-54-03/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-03-03_22-54-03/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-03-03_22-54-03/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 9 | 65 | 3.170 | 101.24 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-03-03_22-54-03/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-03-03_22-54-03/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-03-03_22-54-03/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-03-03_22-54-03/pastas_principais_crescimento_bottom6.png)
...
![Crescimento das linhas por extensão](../Imagens/2026-03-03_22-54-03/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 6.512 | 100.00% | 82 | 221.65 KB |
...
|---:|---:|---:|---:|
| `.png` | 67.691 | 331.57 MB | 98.79% |
| `.ogg` | 1 | 2.99 MB | 0.89% |
| `.jpg` | 1 | 623.44 KB | 0.18% |
| `.py` | 82 | 221.65 KB | 0.06% |
...
![Horas estimadas conforme o tempo](../Imagens/2026-03-03_22-54-03/crescimento_horas_estimadas.png)

...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_zauq11wr`  
**Gerado em:** 2026-04-29T23:18:21  
...
- **Peso dos arquivos de texto:** 218.20 KB
- **Tamanho total:** 0.328 GB (352.593.778 bytes)
- **Dias desde a criação do projeto:** 2
- **Dias desde a criação oficial:** 276
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 6.437
- **Commits (projeto):** 40
...
- **Arquivos `.py`:** 80
- **Linhas totais:** 6.437
- **Tamanho total `.py`:** 218.20 KB
- **Classes encontradas:** 18
- **Funções encontradas:** 207
- **Métodos encontrados:** 110
- **Total funções + métodos:** 317
- **Bibliotecas diferentes usadas:** 24

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-03-04_10-56-20/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-03-04_10-56-20/rank_16_pastas_pizza.png)

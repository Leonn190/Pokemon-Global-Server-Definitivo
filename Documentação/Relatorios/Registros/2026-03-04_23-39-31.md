...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_zfiby8oh`  
**Gerado em:** 2026-04-29T23:18:58  
...
- **Pastas:** 1.131
- **Arquivos:** 67.952
- **Arquivos de texto:** 97
- **Peso dos arquivos de texto:** 604.86 KB
- **Tamanho total:** 0.364 GB (391.347.578 bytes)
- **Dias desde a criação do projeto:** 2
- **Dias desde a criação oficial:** 276
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 8.878
- **Commits (projeto):** 51
...
- **Arquivos `.py`:** 90
- **Linhas totais:** 8.877
- **Tamanho total `.py`:** 304.09 KB
- **Classes encontradas:** 39
- **Funções encontradas:** 230
- **Métodos encontrados:** 230
- **Total funções + métodos:** 460
- **Bibliotecas diferentes usadas:** 26

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-03-04_23-39-31/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-03-04_23-39-31/rank_16_pastas_pizza.png)
...
|---:|---:|---:|---:|
| `.png` | 67.837 | 334.59 MB | 89.65% |
| `.ogg` | 14 | 37.19 MB | 9.97% |
| `.jpg` | 1 | 623.44 KB | 0.16% |
| `.py` | 90 | 304.09 KB | 0.08% |

...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_6kv2epln`  
**Gerado em:** 2026-05-15T09:46:46  
...
- **Peso dos arquivos de texto:** 1019.52 KB
- **Tamanho total:** 0.365 GB (391.913.691 bytes)
- **Dias desde a criação do projeto:** 3
- **Dias desde a criação oficial:** 277
- **Horas estimadas:** 66.00
- **Linhas totais gerais:** 11.871
- **Commits (projeto):** 78

## 2. Python

- **Arquivos `.py`:** 99
- **Linhas totais:** 11.870
- **Tamanho total `.py`:** 417.75 KB
- **Classes encontradas:** 54
- **Funções encontradas:** 283
- **Métodos encontrados:** 350
- **Total funções + métodos:** 633
- **Bibliotecas diferentes usadas:** 27

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-03-05_21-07-40/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-03-05_21-07-40/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-03-05_21-07-40/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 10 | 80 | 7.114 | 244.63 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-03-05_21-07-40/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-03-05_21-07-40/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-03-05_21-07-40/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-03-05_21-07-40/pastas_principais_crescimento_bottom6.png)
...
| 4 | `ModulosMundo` | 0 | 13 | 631 | 20.97 |
| 5 | `ModulosGerais` | 0 | 11 | 623 | 20.44 |
...
![Crescimento das linhas por extensão](../Imagens/2026-03-05_21-07-40/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 11.870 | 99.99% | 99 | 417.75 KB |
...
![Horas estimadas conforme o tempo](../Imagens/2026-03-05_21-07-40/crescimento_horas_estimadas.png)

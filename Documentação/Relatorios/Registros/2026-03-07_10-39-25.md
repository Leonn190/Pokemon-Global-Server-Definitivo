...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_gxp2eebw`  
**Gerado em:** 2026-05-15T09:51:54  
...
- **Peso dos arquivos de texto:** 1244.48 KB
- **Tamanho total:** 0.424 GB (455.000.075 bytes)
- **Dias desde a criação do projeto:** 5
- **Dias desde a criação oficial:** 279
- **Horas estimadas:** 76.50
- **Linhas totais gerais:** 15.299
- **Commits (projeto):** 94

## 2. Python

- **Arquivos `.py`:** 97
- **Linhas totais:** 12.853
- **Tamanho total `.py`:** 459.77 KB
- **Classes encontradas:** 59
- **Funções encontradas:** 285
- **Métodos encontrados:** 395
- **Total funções + métodos:** 680
- **Bibliotecas diferentes usadas:** 28

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-03-07_10-39-25/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-03-07_10-39-25/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-03-07_10-39-25/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 10 | 80 | 7.638 | 267.43 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-03-07_10-39-25/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-03-07_10-39-25/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-03-07_10-39-25/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-03-07_10-39-25/pastas_principais_crescimento_bottom6.png)
...
| 4 | `ModulosMundo` | 1 | 17 | 1.184 | 43.58 |
...
![Gráfico de barras das linhas por extensão](../Imagens/2026-03-07_10-39-25/linhas_por_extensao_barras.png)

![Gráfico de pizza das linhas por extensão](../Imagens/2026-03-07_10-39-25/linhas_por_extensao_pizza.png)

![Crescimento das linhas por extensão](../Imagens/2026-03-07_10-39-25/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 12.853 | 84.01% | 97 | 459.77 KB |
| `.csv` | 1.323 | 8.65% | 2 | 139.23 KB |
| `.java` | 1.109 | 7.25% | 1 | 43.32 KB |
| `.json` | 14 | 0.09% | 2 | 602.15 KB |

## 8. Peso por extensão

![Gráfico de barras do peso por extensão - Top 12](../Imagens/2026-03-07_10-39-25/peso_por_extensao_barras_top12.png)

![Gráfico de pizza do peso por categoria](../Imagens/2026-03-07_10-39-25/peso_por_categoria_pizza.png)

| Ext | Arquivos | Peso | % do jogo |
|---:|---:|---:|---:|
| `.png` | 68.016 | 394.64 MB | 90.95% |
| `.ogg` | 14 | 37.19 MB | 8.57% |
| `.jpg` | 1 | 623.44 KB | 0.14% |
| `.json` | 2 | 602.15 KB | 0.14% |
| `.py` | 97 | 459.77 KB | 0.10% |
...
![Crescimento de peso do jogo](../Imagens/2026-03-07_10-39-25/crescimento_peso_jogo.png)

![Horas estimadas conforme o tempo](../Imagens/2026-03-07_10-39-25/crescimento_horas_estimadas.png)

...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_zwr908ut`  
**Gerado em:** 2026-04-29T23:23:56  
...
- **Peso dos arquivos de texto:** 648.78 KB
- **Tamanho total:** 0.369 GB (396.528.721 bytes)
- **Dias desde a criação do projeto:** 6
- **Dias desde a criação oficial:** 280
- **Horas estimadas:** 80.00
- **Linhas totais gerais:** 15.286
- **Commits (projeto):** 108

## 2. Python

- **Arquivos `.py`:** 96
- **Linhas totais:** 12.393
- **Tamanho total `.py`:** 446.54 KB
- **Classes encontradas:** 59
- **Funções encontradas:** 254
- **Métodos encontrados:** 403
- **Total funções + métodos:** 657
- **Bibliotecas diferentes usadas:** 27

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-03-08_09-43-11/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-03-08_09-43-11/rank_16_pastas_pizza.png)
...
|---:|---:|---:|---:|---:|
| `.py` | 12.393 | 81.07% | 96 | 446.54 KB |
| `.java` | 1.548 | 10.13% | 1 | 62.46 KB |
| `.csv` | 1.323 | 8.65% | 2 | 139.23 KB |

...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_19gaj5ka`  
**Gerado em:** 2026-05-15T09:55:23  
...
- **Peso dos arquivos de texto:** 719.97 KB
- **Tamanho total:** 0.367 GB (394.594.293 bytes)
- **Dias desde a criação do projeto:** 6
- **Dias desde a criação oficial:** 280
- **Horas estimadas:** 87.00
- **Linhas totais gerais:** 17.194
- **Commits (projeto):** 116

## 2. Python

- **Arquivos `.py`:** 97
- **Linhas totais:** 14.300
- **Tamanho total `.py`:** 517.39 KB
- **Classes encontradas:** 60
- **Funções encontradas:** 303
- **Métodos encontrados:** 431
- **Total funções + métodos:** 734
- **Bibliotecas diferentes usadas:** 28

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-03-08_19-00-30/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-03-08_19-00-30/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-03-08_19-00-30/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 10 | 80 | 8.479 | 299.54 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-03-08_19-00-30/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-03-08_19-00-30/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-03-08_19-00-30/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-03-08_19-00-30/pastas_principais_crescimento_bottom6.png)
...
| 4 | `ModulosMundo` | 1 | 17 | 1.431 | 50.24 |
| 5 | `ModulosGerais` | 0 | 11 | 764 | 26.08 |
...
![Crescimento das linhas por extensão](../Imagens/2026-03-08_19-00-30/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 14.300 | 83.17% | 97 | 517.39 KB |
| `.java` | 1.557 | 9.06% | 1 | 62.93 KB |
| `.csv` | 1.323 | 7.69% | 2 | 139.23 KB |
| `.json` | 14 | 0.08% | 1 | 421 bytes |
...
|---:|---:|---:|---:|
| `.png` | 68.013 | 337.53 MB | 89.69% |
| `.ogg` | 14 | 37.19 MB | 9.88% |
| `.jpg` | 1 | 623.44 KB | 0.16% |
| `.py` | 97 | 517.39 KB | 0.13% |
...
![Horas estimadas conforme o tempo](../Imagens/2026-03-08_19-00-30/crescimento_horas_estimadas.png)

...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_gpkhvtlj`  
**Gerado em:** 2026-05-15T10:06:10  
...
- **Peso dos arquivos de texto:** 1146.29 KB
- **Tamanho total:** 0.378 GB (405.984.043 bytes)
- **Dias desde a criação do projeto:** 15
- **Dias desde a criação oficial:** 289
- **Horas estimadas:** 139.00
- **Linhas totais gerais:** 27.667
- **Commits (projeto):** 171

## 2. Python

- **Arquivos `.py`:** 119
- **Linhas totais:** 21.102
- **Tamanho total `.py`:** 826.42 KB
- **Classes encontradas:** 79
- **Funções encontradas:** 379
- **Métodos encontrados:** 773
- **Total funções + métodos:** 1.152
- **Bibliotecas diferentes usadas:** 31

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-03-17_21-27-30/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-03-17_21-27-30/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-03-17_21-27-30/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 11 | 87 | 12.840 | 484.62 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-03-17_21-27-30/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-03-17_21-27-30/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-03-17_21-27-30/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-03-17_21-27-30/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Ferramentas` | 0 | 5 | 3.775 | 135.47 |
| 2 | `Telas` | 1 | 15 | 3.331 | 118.83 |
| 3 | `ModulosMundo` | 1 | 16 | 2.301 | 98.21 |
...
![Crescimento das linhas por extensão](../Imagens/2026-03-17_21-27-30/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 21.102 | 76.27% | 119 | 826.42 KB |
| `.java` | 2.775 | 10.03% | 1 | 120.61 KB |
| `.json` | 2.426 | 8.77% | 6 | 58.34 KB |
| `.csv` | 1.364 | 4.93% | 3 | 140.92 KB |
...
|---:|---:|---:|---:|
| `.png` | 68.038 | 338.81 MB | 87.51% |
| `.ogg` | 17 | 46.32 MB | 11.96% |
| `.py` | 119 | 826.42 KB | 0.21% |
...
![Horas estimadas conforme o tempo](../Imagens/2026-03-17_21-27-30/crescimento_horas_estimadas.png)

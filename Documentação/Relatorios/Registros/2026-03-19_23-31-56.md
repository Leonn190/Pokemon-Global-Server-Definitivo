...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_jmfhcjru`  
**Gerado em:** 2026-05-15T10:07:49  
...
- **Peso dos arquivos de texto:** 1171.49 KB
- **Tamanho total:** 0.379 GB (406.728.931 bytes)
- **Dias desde a criação do projeto:** 17
- **Dias desde a criação oficial:** 291
- **Horas estimadas:** 142.50
- **Linhas totais gerais:** 28.286
- **Commits (projeto):** 178

## 2. Python

- **Arquivos `.py`:** 118
- **Linhas totais:** 21.457
- **Tamanho total `.py`:** 843.50 KB
- **Classes encontradas:** 78
- **Funções encontradas:** 382
- **Métodos encontrados:** 788
- **Total funções + métodos:** 1.170
- **Bibliotecas diferentes usadas:** 31

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-03-19_23-31-56/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-03-19_23-31-56/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-03-19_23-31-56/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 11 | 86 | 12.900 | 487.53 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-03-19_23-31-56/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-03-19_23-31-56/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-03-19_23-31-56/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-03-19_23-31-56/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Ferramentas` | 0 | 5 | 3.775 | 135.47 |
| 2 | `Telas` | 1 | 15 | 3.331 | 118.83 |
| 3 | `ModulosMundo` | 1 | 16 | 2.189 | 96.56 |
| 4 | `Prefabs` | 0 | 12 | 2.010 | 69.33 |
| 5 | `Paineis` | 0 | 10 | 1.603 | 56.76 |
| 6 | `ModulosGerais` | 0 | 11 | 773 | 27.47 |
...
![Crescimento das linhas por extensão](../Imagens/2026-03-19_23-31-56/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 21.457 | 75.86% | 118 | 843.50 KB |
| `.java` | 2.775 | 9.81% | 1 | 120.61 KB |
| `.json` | 2.670 | 9.44% | 7 | 64.51 KB |
| `.csv` | 1.384 | 4.89% | 3 | 142.88 KB |
...
![Horas estimadas conforme o tempo](../Imagens/2026-03-19_23-31-56/crescimento_horas_estimadas.png)

...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_whc4uodh`  
**Gerado em:** 2026-04-29T23:36:14  
...
- **Pastas:** 1.177
- **Arquivos:** 68.906
- **Arquivos de texto:** 136
- **Peso dos arquivos de texto:** 1333.92 KB
- **Tamanho total:** 0.396 GB (425.065.744 bytes)
- **Dias desde a criação do projeto:** 30
- **Dias desde a criação oficial:** 304
- **Horas estimadas:** 180.00
- **Linhas totais gerais:** 31.703
- **Commits (projeto):** 214

## 2. Python

- **Arquivos `.py`:** 122
- **Linhas totais:** 24.851
- **Tamanho total `.py`:** 1001.91 KB
- **Classes encontradas:** 91
- **Funções encontradas:** 360
- **Métodos encontrados:** 1.027
- **Total funções + métodos:** 1.387
- **Bibliotecas diferentes usadas:** 31

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-04-01_02-32-36/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-04-01_02-32-36/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Telas` | 1 | 15 | 3.995 | 149.81 |
| 2 | `Paineis` | 0 | 12 | 3.688 | 149.74 |
| 3 | `Outros` | 0 | 4 | 2.679 | 97.35 |
| 4 | `Prefabs` | 0 | 14 | 2.655 | 94.26 |
| 5 | `Geradores` | 1 | 16 | 2.447 | 109.07 |
...
|---:|---:|---:|---:|---:|
| `.py` | 24.851 | 78.39% | 122 | 1001.91 KB |
| `.java` | 2.775 | 8.75% | 1 | 120.61 KB |
| `.json` | 2.673 | 8.43% | 7 | 64.57 KB |
| `.csv` | 1.404 | 4.43% | 4 | 146.84 KB |
...
|---:|---:|---:|---:|
| `.png` | 68.733 | 356.65 MB | 87.98% |
| `.ogg` | 17 | 46.32 MB | 11.43% |
| `.py` | 122 | 1001.91 KB | 0.24% |

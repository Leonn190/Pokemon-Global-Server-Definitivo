...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_rfd20b78`  
**Gerado em:** 2026-05-15T10:16:36  
...
- **Peso dos arquivos de texto:** 1442.03 KB
- **Tamanho total:** 0.399 GB (427.887.939 bytes)
- **Dias desde a criação do projeto:** 32
- **Dias desde a criação oficial:** 306
- **Horas estimadas:** 193.50
- **Linhas totais gerais:** 34.340
- **Commits (projeto):** 234

## 2. Python

- **Arquivos `.py`:** 125
- **Linhas totais:** 27.359
- **Tamanho total `.py`:** 1101.54 KB
- **Classes encontradas:** 93
- **Funções encontradas:** 424
- **Métodos encontrados:** 1.099
- **Total funções + métodos:** 1.523
- **Bibliotecas diferentes usadas:** 40

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-04-03_01-22-40/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-04-03_01-22-40/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-04-03_01-22-40/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 11 | 93 | 18.166 | 721.02 |
| 2 | `Dados` | `Dados` | 0 | 6 | 1.625 | 157.56 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-04-03_01-22-40/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-04-03_01-22-40/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-04-03_01-22-40/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-04-03_01-22-40/pastas_principais_crescimento_bottom6.png)
...
| 4 | `Prefabs` | 0 | 14 | 2.823 | 100.76 |
| 5 | `ModulosMundo` | 1 | 16 | 2.576 | 114.22 |
...
![Crescimento das linhas por extensão](../Imagens/2026-04-03_01-22-40/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 27.359 | 79.67% | 125 | 1.08 MB |
| `.java` | 2.775 | 8.08% | 1 | 120.61 KB |
| `.json` | 2.673 | 7.78% | 7 | 64.57 KB |
| `.csv` | 1.533 | 4.46% | 5 | 155.32 KB |
...
![Horas estimadas conforme o tempo](../Imagens/2026-04-03_01-22-40/crescimento_horas_estimadas.png)

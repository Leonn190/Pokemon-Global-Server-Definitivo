...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_2ejqa9wl`  
**Gerado em:** 2026-05-15T10:31:00  
...
- **Pastas:** 1.187
- **Arquivos:** 69.074
- **Arquivos de texto:** 201
- **Peso dos arquivos de texto:** 2154.39 KB
- **Tamanho total:** 0.445 GB (477.317.465 bytes)
- **Dias desde a criação do projeto:** 40
- **Dias desde a criação oficial:** 314
- **Horas estimadas:** 270.00
- **Linhas totais gerais:** 50.338
- **Commits (projeto):** 320

## 2. Python

- **Arquivos `.py`:** 150
- **Linhas totais:** 41.693
- **Tamanho total `.py`:** 1756.82 KB
- **Classes encontradas:** 141
- **Funções encontradas:** 522
- **Métodos encontrados:** 1.827
- **Total funções + métodos:** 2.349
- **Bibliotecas diferentes usadas:** 43

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-04-11_21-18-12/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-04-11_21-18-12/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-04-11_21-18-12/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 13 | 110 | 27.309 | 1138.99 |
| 2 | `Dados` | `Dados` | 3 | 36 | 4.789 | 251.31 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-04-11_21-18-12/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-04-11_21-18-12/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-04-11_21-18-12/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-04-11_21-18-12/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `ModulosMundo` | 1 | 28 | 7.496 | 338.93 |
| 2 | `Ferramentas` | 0 | 7 | 6.466 | 252.10 |
| 3 | `Telas` | 1 | 18 | 5.309 | 208.57 |
| 4 | `Paineis` | 0 | 15 | 5.256 | 221.84 |
| 5 | `ModulosGerais` | 0 | 22 | 3.813 | 146.22 |
...
![Gráfico de barras das linhas por extensão](../Imagens/2026-04-11_21-18-12/linhas_por_extensao_barras.png)

![Gráfico de pizza das linhas por extensão](../Imagens/2026-04-11_21-18-12/linhas_por_extensao_pizza.png)

![Crescimento das linhas por extensão](../Imagens/2026-04-11_21-18-12/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 41.693 | 82.84% | 150 | 1.72 MB |
| `.json` | 3.773 | 7.50% | 29 | 98.40 KB |
| `.java` | 2.835 | 5.63% | 1 | 123.53 KB |
| `.csv` | 1.674 | 3.33% | 8 | 167.51 KB |
| `.toml` | 357 | 0.71% | 10 | 8.07 KB |

## 8. Peso por extensão

![Gráfico de barras do peso por extensão - Top 12](../Imagens/2026-04-11_21-18-12/peso_por_extensao_barras_top12.png)

![Gráfico de pizza do peso por categoria](../Imagens/2026-04-11_21-18-12/peso_por_categoria_pizza.png)

| Ext | Arquivos | Peso | % do jogo |
|---:|---:|---:|---:|
| `.png` | 68.788 | 358.07 MB | 78.66% |
...
![Crescimento de peso do jogo](../Imagens/2026-04-11_21-18-12/crescimento_peso_jogo.png)

![Horas estimadas conforme o tempo](../Imagens/2026-04-11_21-18-12/crescimento_horas_estimadas.png)

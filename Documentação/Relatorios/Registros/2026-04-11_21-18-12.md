...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_27w_ur6q`  
**Gerado em:** 2026-04-29T23:47:25  
...
- **Pastas:** 1.185
- **Arquivos:** 69.073
- **Arquivos de texto:** 200
- **Peso dos arquivos de texto:** 2104.46 KB
- **Tamanho total:** 0.444 GB (477.266.329 bytes)
- **Dias desde a criação do projeto:** 40
- **Dias desde a criação oficial:** 314
- **Horas estimadas:** 270.00
- **Linhas totais gerais:** 48.916
- **Commits (projeto):** 320

## 2. Python

- **Arquivos `.py`:** 149
- **Linhas totais:** 40.271
- **Tamanho total `.py`:** 1706.88 KB
- **Classes encontradas:** 141
- **Funções encontradas:** 473
- **Métodos encontrados:** 1.827
- **Total funções + métodos:** 2.300
- **Bibliotecas diferentes usadas:** 43

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-04-11_21-18-12/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-04-11_21-18-12/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Telas` | 1 | 18 | 5.309 | 208.57 |
| 2 | `Paineis` | 0 | 15 | 5.256 | 221.84 |
| 3 | `Outros` | 0 | 6 | 5.044 | 202.17 |
| 4 | `Dados` | 3 | 36 | 4.789 | 251.31 |
| 5 | `Geradores` | 1 | 16 | 3.845 | 171.42 |
| 6 | `ModulosMundo` | 0 | 12 | 3.651 | 167.51 |
| 7 | `Prefabs` | 0 | 15 | 3.328 | 120.18 |
| 8 | `ModulosGerais` | 0 | 11 | 2.474 | 91.06 |
| 9 | `ModulosBatalha` | 0 | 9 | 2.026 | 93.45 |
| 10 | `Cenas` | 0 | 6 | 934 | 40.47 |
| 11 | `ServerLogica` | 0 | 3 | 251 | 12.39 |
| 12 | `ServerBatalha` | 0 | 4 | 101 | 4.16 |
...
|---:|---:|---:|---:|---:|
| `.py` | 40.271 | 82.34% | 149 | 1.67 MB |
| `.json` | 3.773 | 7.71% | 29 | 98.40 KB |
| `.java` | 2.835 | 5.80% | 1 | 123.53 KB |
| `.csv` | 1.674 | 3.42% | 8 | 167.51 KB |
| `.toml` | 357 | 0.73% | 10 | 8.07 KB |

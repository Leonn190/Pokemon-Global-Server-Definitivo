...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_tpov565u`  
**Gerado em:** 2026-05-15T10:32:57  
...
- **Pastas:** 1.188
- **Arquivos:** 69.085
- **Arquivos de texto:** 212
- **Peso dos arquivos de texto:** 2291.88 KB
- **Tamanho total:** 0.445 GB (477.458.252 bytes)
- **Dias desde a criação do projeto:** 41
- **Dias desde a criação oficial:** 315
- **Horas estimadas:** 276.00
- **Linhas totais gerais:** 53.197
- **Commits (projeto):** 323

## 2. Python

- **Arquivos `.py`:** 161
- **Linhas totais:** 44.536
- **Tamanho total `.py`:** 1893.67 KB
- **Classes encontradas:** 155
- **Funções encontradas:** 536
- **Métodos encontrados:** 1.963
- **Total funções + métodos:** 2.499
- **Bibliotecas diferentes usadas:** 43

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-04-12_04-53-25/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-04-12_04-53-25/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-04-12_04-53-25/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 13 | 110 | 27.309 | 1138.99 |
| 2 | `Dados` | `Dados` | 3 | 36 | 4.805 | 251.94 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-04-12_04-53-25/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-04-12_04-53-25/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-04-12_04-53-25/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-04-12_04-53-25/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `ModulosMundo` | 1 | 28 | 7.496 | 338.93 |
| 2 | `Ferramentas` | 0 | 7 | 6.466 | 252.29 |
...
![Crescimento das linhas por extensão](../Imagens/2026-04-12_04-53-25/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 44.536 | 83.73% | 161 | 1.85 MB |
| `.json` | 3.789 | 7.12% | 29 | 99.03 KB |
| `.java` | 2.835 | 5.33% | 1 | 123.53 KB |
| `.csv` | 1.674 | 3.15% | 8 | 167.51 KB |
| `.toml` | 357 | 0.67% | 10 | 8.07 KB |
...
|---:|---:|---:|---:|
| `.png` | 68.788 | 358.07 MB | 78.64% |
| `.ogg` | 34 | 87.67 MB | 19.25% |
| `.wav` | 9 | 3.81 MB | 0.84% |
| `.jpg` | 21 | 3.14 MB | 0.69% |
| `.py` | 161 | 1.85 MB | 0.41% |
...
![Horas estimadas conforme o tempo](../Imagens/2026-04-12_04-53-25/crescimento_horas_estimadas.png)

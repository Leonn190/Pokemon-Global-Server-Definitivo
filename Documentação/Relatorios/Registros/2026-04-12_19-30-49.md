...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_cjj03fnj`  
**Gerado em:** 2026-05-15T10:34:57  
...
- **Peso dos arquivos de texto:** 2344.22 KB
- **Tamanho total:** 0.541 GB (581.083.409 bytes)
- **Dias desde a criação do projeto:** 41
- **Dias desde a criação oficial:** 315
- **Horas estimadas:** 286.00
- **Linhas totais gerais:** 54.546
- **Commits (projeto):** 328

## 2. Python

- **Arquivos `.py`:** 164
- **Linhas totais:** 45.502
- **Tamanho total `.py`:** 1929.69 KB
- **Classes encontradas:** 158
- **Funções encontradas:** 575
- **Métodos encontrados:** 1.991
- **Total funções + métodos:** 2.566
- **Bibliotecas diferentes usadas:** 44

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-04-12_19-30-49/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-04-12_19-30-49/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-04-12_19-30-49/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 13 | 111 | 27.627 | 1152.00 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-04-12_19-30-49/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-04-12_19-30-49/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-04-12_19-30-49/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-04-12_19-30-49/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `ModulosMundo` | 1 | 28 | 7.506 | 339.30 |
| 2 | `Ferramentas` | 0 | 8 | 6.653 | 259.64 |
| 3 | `Telas` | 1 | 18 | 5.309 | 208.57 |
| 4 | `Paineis` | 0 | 15 | 5.256 | 221.84 |
| 5 | `ModulosGerais` | 0 | 23 | 4.121 | 158.85 |
| 6 | `Prefabs` | 0 | 15 | 3.328 | 120.18 |
| 7 | `ModulosBatalha` | 0 | 9 | 2.026 | 93.45 |
| 8 | `Visual` | 0 | 0 | 0 | 0.00 |
...
![Gráfico de barras das linhas por extensão](../Imagens/2026-04-12_19-30-49/linhas_por_extensao_barras.png)

![Gráfico de pizza das linhas por extensão](../Imagens/2026-04-12_19-30-49/linhas_por_extensao_pizza.png)

![Crescimento das linhas por extensão](../Imagens/2026-04-12_19-30-49/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 45.502 | 83.43% | 164 | 1.88 MB |
| `.json` | 4.151 | 7.61% | 29 | 113.51 KB |
| `.java` | 2.835 | 5.20% | 1 | 123.53 KB |
| `.csv` | 1.695 | 3.11% | 9 | 169.36 KB |
| `.toml` | 357 | 0.65% | 10 | 8.07 KB |

## 8. Peso por extensão

![Gráfico de barras do peso por extensão - Top 12](../Imagens/2026-04-12_19-30-49/peso_por_extensao_barras_top12.png)

![Gráfico de pizza do peso por categoria](../Imagens/2026-04-12_19-30-49/peso_por_categoria_pizza.png)

| Ext | Arquivos | Peso | % do jogo |
|---:|---:|---:|---:|
| `.png` | 71.744 | 456.84 MB | 82.44% |
...
![Crescimento de peso do jogo](../Imagens/2026-04-12_19-30-49/crescimento_peso_jogo.png)

![Horas estimadas conforme o tempo](../Imagens/2026-04-12_19-30-49/crescimento_horas_estimadas.png)

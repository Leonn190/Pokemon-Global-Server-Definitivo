...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_kubn50rt`  
**Gerado em:** 2026-05-15T10:36:46  
...
- **Peso dos arquivos de texto:** 2485.10 KB
- **Tamanho total:** 0.541 GB (581.227.667 bytes)
- **Dias desde a criação do projeto:** 42
- **Dias desde a criação oficial:** 316
- **Horas estimadas:** 295.50
- **Linhas totais gerais:** 57.862
- **Commits (projeto):** 333

## 2. Python

- **Arquivos `.py`:** 166
- **Linhas totais:** 48.818
- **Tamanho total `.py`:** 2070.56 KB
- **Classes encontradas:** 158
- **Funções encontradas:** 657
- **Métodos encontrados:** 2.037
- **Total funções + métodos:** 2.694
- **Bibliotecas diferentes usadas:** 44

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-04-13_06-58-40/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-04-13_06-58-40/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-04-13_06-58-40/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 13 | 111 | 28.331 | 1186.14 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-04-13_06-58-40/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-04-13_06-58-40/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-04-13_06-58-40/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-04-13_06-58-40/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Ferramentas` | 0 | 10 | 8.477 | 324.67 |
| 2 | `ModulosMundo` | 1 | 28 | 7.614 | 345.97 |
| 3 | `Telas` | 1 | 18 | 5.309 | 208.57 |
| 4 | `Paineis` | 0 | 15 | 5.256 | 221.84 |
| 5 | `ModulosGerais` | 0 | 23 | 4.413 | 170.29 |
| 6 | `Prefabs` | 0 | 15 | 3.328 | 120.18 |
| 7 | `ModulosBatalha` | 0 | 9 | 2.330 | 109.48 |
| 8 | `Visual` | 0 | 0 | 0 | 0.00 |
...
![Crescimento das linhas por extensão](../Imagens/2026-04-13_06-58-40/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 48.818 | 84.38% | 166 | 2.02 MB |
| `.json` | 4.151 | 7.17% | 29 | 113.51 KB |
| `.java` | 2.835 | 4.90% | 1 | 123.53 KB |
| `.csv` | 1.695 | 2.93% | 9 | 169.36 KB |
| `.toml` | 357 | 0.62% | 10 | 8.07 KB |
...
![Horas estimadas conforme o tempo](../Imagens/2026-04-13_06-58-40/crescimento_horas_estimadas.png)

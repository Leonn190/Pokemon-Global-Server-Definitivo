...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_5e1zpsz4`  
**Gerado em:** 2026-05-15T10:45:01  
...
- **Peso dos arquivos de texto:** 2691.34 KB
- **Tamanho total:** 0.554 GB (594.524.522 bytes)
- **Dias desde a criação do projeto:** 47
- **Dias desde a criação oficial:** 321
- **Horas estimadas:** 339.50
- **Linhas totais gerais:** 62.773
- **Commits (projeto):** 364

## 2. Python

- **Arquivos `.py`:** 168
- **Linhas totais:** 52.039
- **Tamanho total `.py`:** 2233.22 KB
- **Classes encontradas:** 169
- **Funções encontradas:** 647
- **Métodos encontrados:** 2.272
- **Total funções + métodos:** 2.919
- **Bibliotecas diferentes usadas:** 44

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-04-18_17-57-02/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-04-18_17-57-02/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-04-18_17-57-02/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 13 | 114 | 31.858 | 1346.36 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-04-18_17-57-02/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-04-18_17-57-02/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-04-18_17-57-02/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-04-18_17-57-02/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `ModulosMundo` | 1 | 28 | 7.834 | 356.25 |
| 2 | `Ferramentas` | 0 | 9 | 7.424 | 290.03 |
| 3 | `Paineis` | 0 | 16 | 6.001 | 258.42 |
| 4 | `Telas` | 1 | 19 | 5.496 | 217.43 |
| 5 | `ModulosGerais` | 0 | 23 | 5.321 | 209.88 |
...
![Crescimento das linhas por extensão](../Imagens/2026-04-18_17-57-02/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 52.039 | 82.91% | 168 | 2.18 MB |
| `.json` | 4.151 | 6.61% | 29 | 113.51 KB |
| `.java` | 3.836 | 6.11% | 7 | 144.65 KB |
| `.csv` | 1.702 | 2.71% | 9 | 178.67 KB |
| `.toml` | 1.039 | 1.66% | 14 | 21.23 KB |
...
![Horas estimadas conforme o tempo](../Imagens/2026-04-18_17-57-02/crescimento_horas_estimadas.png)

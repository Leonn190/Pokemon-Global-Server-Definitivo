...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_4def2v7k`  
**Gerado em:** 2026-05-15T10:50:51  
...
- **Peso dos arquivos de texto:** 2801.54 KB
- **Tamanho total:** 0.568 GB (610.385.567 bytes)
- **Dias desde a criação do projeto:** 50
- **Dias desde a criação oficial:** 324
- **Horas estimadas:** 360.50
- **Linhas totais gerais:** 65.202
- **Commits (projeto):** 385

## 2. Python

- **Arquivos `.py`:** 175
- **Linhas totais:** 54.461
- **Tamanho total `.py`:** 2342.93 KB
- **Classes encontradas:** 173
- **Funções encontradas:** 681
- **Métodos encontrados:** 2.342
- **Total funções + métodos:** 3.023
- **Bibliotecas diferentes usadas:** 44

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-04-21_05-37-12/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-04-21_05-37-12/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-04-21_05-37-12/macro_areas_crescimento.png)
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-04-21_05-37-12/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-04-21_05-37-12/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-04-21_05-37-12/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-04-21_05-37-12/pastas_principais_crescimento_bottom6.png)
...
![Crescimento das linhas por extensão](../Imagens/2026-04-21_05-37-12/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 54.461 | 83.53% | 175 | 2.29 MB |
| `.json` | 4.151 | 6.37% | 29 | 113.51 KB |
| `.java` | 3.843 | 5.89% | 7 | 145.13 KB |
| `.csv` | 1.702 | 2.61% | 9 | 178.67 KB |
...
![Horas estimadas conforme o tempo](../Imagens/2026-04-21_05-37-12/crescimento_horas_estimadas.png)

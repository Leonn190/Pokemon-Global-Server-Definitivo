...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_i5bslwkw`  
**Gerado em:** 2026-05-15T10:52:58  
...
- **Pastas:** 1.255
- **Arquivos:** 72.142
- **Arquivos de texto:** 236
- **Peso dos arquivos de texto:** 3025.06 KB
- **Tamanho total:** 0.569 GB (610.614.452 bytes)
- **Dias desde a criação do projeto:** 52
- **Dias desde a criação oficial:** 326
- **Horas estimadas:** 366.00
- **Linhas totais gerais:** 71.924
- **Commits (projeto):** 401

## 2. Python

- **Arquivos `.py`:** 175
- **Linhas totais:** 54.896
- **Tamanho total `.py`:** 2360.52 KB
- **Classes encontradas:** 173
- **Funções encontradas:** 704
- **Métodos encontrados:** 2.342
- **Total funções + métodos:** 3.046
- **Bibliotecas diferentes usadas:** 44

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-04-23_20-05-25/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-04-23_20-05-25/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-04-23_20-05-25/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 13 | 120 | 33.427 | 1417.48 |
| 2 | `Dados` | `Dados` | 3 | 37 | 5.201 | 277.80 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-04-23_20-05-25/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-04-23_20-05-25/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-04-23_20-05-25/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-04-23_20-05-25/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `ModulosMundo` | 1 | 30 | 8.264 | 374.51 |
| 2 | `Ferramentas` | 0 | 9 | 7.858 | 307.64 |
| 3 | `Paineis` | 0 | 16 | 6.008 | 258.83 |
| 4 | `Telas` | 1 | 19 | 5.733 | 228.58 |
| 5 | `ModulosGerais` | 0 | 26 | 5.683 | 227.36 |
| 6 | `ModulosBatalha` | 0 | 12 | 4.059 | 186.92 |
...
![Gráfico de barras das linhas por extensão](../Imagens/2026-04-23_20-05-25/linhas_por_extensao_barras.png)

![Gráfico de pizza das linhas por extensão](../Imagens/2026-04-23_20-05-25/linhas_por_extensao_pizza.png)

![Crescimento das linhas por extensão](../Imagens/2026-04-23_20-05-25/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 54.896 | 76.33% | 175 | 2.31 MB |
| `.md` | 6.281 | 8.73% | 1 | 205.72 KB |
| `.json` | 4.151 | 5.77% | 29 | 113.51 KB |
| `.java` | 3.843 | 5.34% | 7 | 145.13 KB |
| `.csv` | 1.708 | 2.37% | 9 | 178.88 KB |
| `.toml` | 1.039 | 1.44% | 14 | 21.23 KB |

## 8. Peso por extensão

![Gráfico de barras do peso por extensão - Top 12](../Imagens/2026-04-23_20-05-25/peso_por_extensao_barras_top12.png)

![Gráfico de pizza do peso por categoria](../Imagens/2026-04-23_20-05-25/peso_por_categoria_pizza.png)
...
![Crescimento de linhas gerais](../Imagens/2026-04-23_20-05-25/crescimento_linhas_totais.png)

![Crescimento de linhas .py](../Imagens/2026-04-23_20-05-25/crescimento_linhas_py.png)

![Crescimento de arquivos .py](../Imagens/2026-04-23_20-05-25/crescimento_arquivos_py.png)

![Crescimento de commits](../Imagens/2026-04-23_20-05-25/crescimento_commits.png)

![Crescimento de peso do jogo](../Imagens/2026-04-23_20-05-25/crescimento_peso_jogo.png)

![Horas estimadas conforme o tempo](../Imagens/2026-04-23_20-05-25/crescimento_horas_estimadas.png)

...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_043hg4b8`  
**Gerado em:** 2026-05-15T10:55:01  
...
- **Pastas:** 1.256
- **Arquivos:** 72.146
- **Arquivos de texto:** 240
- **Peso dos arquivos de texto:** 3075.11 KB
- **Tamanho total:** 0.569 GB (610.665.697 bytes)
- **Dias desde a criação do projeto:** 52
- **Dias desde a criação oficial:** 326
- **Horas estimadas:** 369.00
- **Linhas totais gerais:** 73.473
- **Commits (projeto):** 404

## 2. Python

- **Arquivos `.py`:** 178
- **Linhas totais:** 55.245
- **Tamanho total `.py`:** 2377.89 KB
- **Classes encontradas:** 176
- **Funções encontradas:** 718
- **Métodos encontrados:** 2.332
- **Total funções + métodos:** 3.050
- **Bibliotecas diferentes usadas:** 45

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-04-23_23-56-01/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-04-23_23-56-01/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-04-23_23-56-01/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 13 | 119 | 33.096 | 1404.82 |
| 2 | `Dados` | `Dados` | 3 | 38 | 6.401 | 310.46 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-04-23_23-56-01/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-04-23_23-56-01/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-04-23_23-56-01/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-04-23_23-56-01/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Ferramentas` | 1 | 12 | 8.466 | 335.76 |
| 2 | `ModulosMundo` | 1 | 30 | 8.264 | 374.51 |
| 3 | `Paineis` | 0 | 16 | 6.038 | 260.43 |
| 4 | `Telas` | 1 | 19 | 5.733 | 228.58 |
| 5 | `ModulosGerais` | 0 | 26 | 5.683 | 227.36 |
| 6 | `ModulosBatalha` | 0 | 11 | 3.698 | 172.67 |
...
![Crescimento das linhas por extensão](../Imagens/2026-04-23_23-56-01/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 55.245 | 75.20% | 178 | 2.32 MB |
| `.md` | 6.281 | 8.55% | 1 | 205.72 KB |
| `.json` | 5.351 | 7.28% | 30 | 146.18 KB |
| `.java` | 3.843 | 5.23% | 7 | 145.13 KB |
| `.csv` | 1.708 | 2.32% | 9 | 178.88 KB |
| `.toml` | 1.039 | 1.41% | 14 | 21.23 KB |
...
![Horas estimadas conforme o tempo](../Imagens/2026-04-23_23-56-01/crescimento_horas_estimadas.png)

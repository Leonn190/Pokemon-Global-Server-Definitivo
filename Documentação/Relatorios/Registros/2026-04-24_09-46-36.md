...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_u5zxp2ko`  
**Gerado em:** 2026-05-15T10:56:54  
...
- **Pastas:** 1.253
- **Arquivos:** 72.114
- **Arquivos de texto:** 208
- **Peso dos arquivos de texto:** 2468.08 KB
- **Tamanho total:** 0.568 GB (610.044.100 bytes)
- **Dias desde a criação do projeto:** 53
- **Dias desde a criação oficial:** 327
- **Horas estimadas:** 377.00
- **Linhas totais gerais:** 59.839
- **Commits (projeto):** 407

## 2. Python

- **Arquivos `.py`:** 148
- **Linhas totais:** 43.021
- **Tamanho total `.py`:** 1807.06 KB
- **Classes encontradas:** 135
- **Funções encontradas:** 650
- **Métodos encontrados:** 1.745
- **Total funções + métodos:** 2.395
- **Bibliotecas diferentes usadas:** 44

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-04-24_09-46-36/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-04-24_09-46-36/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-04-24_09-46-36/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 13 | 109 | 28.226 | 1178.33 |
| 2 | `Dados` | `Dados` | 3 | 36 | 4.779 | 261.17 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-04-24_09-46-36/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-04-24_09-46-36/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-04-24_09-46-36/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-04-24_09-46-36/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `ModulosMundo` | 1 | 29 | 7.617 | 342.94 |
| 2 | `Paineis` | 0 | 16 | 6.038 | 260.46 |
| 3 | `Ferramentas` | 0 | 7 | 5.791 | 213.64 |
| 4 | `Telas` | 1 | 19 | 5.733 | 228.58 |
| 5 | `ModulosGerais` | 0 | 26 | 4.965 | 196.59 |
| 6 | `Prefabs` | 0 | 14 | 3.597 | 131.39 |
| 7 | `ModulosBatalha` | 0 | 2 | 193 | 8.48 |
| 8 | `Visual` | 0 | 0 | 0 | 0.00 |
...
![Crescimento das linhas por extensão](../Imagens/2026-04-24_09-46-36/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 43.021 | 71.90% | 148 | 1.76 MB |
| `.md` | 6.493 | 10.85% | 1 | 218.81 KB |
| `.java` | 3.843 | 6.42% | 7 | 145.13 KB |
| `.json` | 3.729 | 6.23% | 28 | 96.89 KB |
| `.csv` | 1.708 | 2.85% | 9 | 178.88 KB |
| `.toml` | 1.039 | 1.74% | 14 | 21.23 KB |
...
![Horas estimadas conforme o tempo](../Imagens/2026-04-24_09-46-36/crescimento_horas_estimadas.png)

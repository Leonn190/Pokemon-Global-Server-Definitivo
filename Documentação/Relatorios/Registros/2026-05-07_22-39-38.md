...
- **Pastas:** 1.298
- **Arquivos:** 74.264
- **Arquivos de texto:** 409
- **Peso dos arquivos de texto:** 4159.98 KB
- **Tamanho total:** 1.046 GB (1.123.509.094 bytes)
- **Dias desde a criação do projeto:** 66
- **Dias desde a criação oficial:** 340
- **Horas estimadas:** 566.00
- **Linhas totais gerais:** 97.611
- **Commits (projeto):** 605
- **Adições desde o último relatório:** <span style='color: green'>+11.200</span>
- **Reduções desde o último relatório:** <span style='color: red'>-3.592</span>

## 2. Python

- **Arquivos `.py`:** 240
- **Linhas totais:** 71.248
- **Tamanho total `.py`:** 3151.38 KB
- **Classes encontradas:** 222
- **Funções encontradas:** 1.060
- **Métodos encontrados:** 3.070
- **Total funções + métodos:** 4.130
- **Bibliotecas diferentes usadas:** 47

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-05-07_22-39-38/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-05-07_22-39-38/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Site` | 23 | 1.637 | 11.286 | 30751.36 |
| 2 | `ServerGerais` | 4 | 55 | 10.540 | 585.95 |
| 3 | `Paineis` | 0 | 16 | 8.388 | 377.83 |
| 4 | `Dados` | 6 | 61 | 8.266 | 406.32 |
| 5 | `ServerBatalha` | 1 | 26 | 7.736 | 346.52 |
| 6 | `ServerMundo` | 2 | 25 | 6.523 | 348.36 |
| 7 | `Telas` | 2 | 20 | 6.163 | 241.68 |
| 8 | `Outros` | 0 | 10 | 6.106 | 229.85 |
| 9 | `ModulosBatalha` | 0 | 13 | 5.373 | 259.09 |
| 10 | `ModulosMundo` | 0 | 16 | 5.011 | 236.14 |
| 11 | `ModulosGerais` | 1 | 25 | 4.846 | 185.82 |
| 12 | `ServerLogica` | 4 | 42 | 4.427 | 137.59 |
| 13 | `Geradores` | 1 | 19 | 4.322 | 196.57 |
| 14 | `Prefabs` | 0 | 14 | 3.580 | 131.89 |
| 15 | `Visual` | 0 | 9 | 2.732 | 119.68 |
| 16 | `Cenas` | 0 | 6 | 1.883 | 94.15 |
...
| `SimuladorServerJogo/Gerais/EstadoServidor.py` | 1.344 | 57.76 |
| `Codigo/Paineis/FichaPokemon.py` | 1.265 | 56.96 |
| `Codigo/ModulosMundo/ControladorObjetos.py` | 1.261 | 64.03 |
| `Codigo/ModulosBatalha/MontadorJogadas.py` | 1.217 | 60.79 |
| `SimuladorServerJogo/Batalha/PokemonBatalha.py` | 1.121 | 57.91 |
...
| `SimuladorServerJogo/Batalha/Partida.py` | 1.028 | 50.88 |
| `Codigo/Cenas/CenaMundo.py` | 962 | 55.62 |
| `SimuladorServerJogo/Gerais/Geradores/GeradorPokemon.py` | 922 | 38.32 |
| `Codigo/ModulosMundo/ControladorPlayer.py` | 920 | 45.11 |
| `SimuladorServerJogo/Mundo/Cerebros/CerebroDungeons.py` | 919 | 53.56 |
| `SimuladorServerJogo/Gerais/Geradores/GeradorDungeons.py` | 881 | 40.18 |
| `Codigo/Prefabs/Texto.py` | 819 | 31.41 |
| `SimuladorServerJogo/Mundo/BancoDados.py` | 803 | 40.04 |
| `Codigo/Visual/PokemonBatalhaAnimator.py` | 770 | 34.53 |
| `SimuladorServerJogo/Mundo/Cerebros/CerebroNPCs.py` | 747 | 39.54 |
| `SimuladorServerJogo/Gerais/Rotas/Atualizador.py` | 743 | 40.17 |
...
| `Codigo/ModulosBatalha/ControladorBatalha.py` | 680 | 32.80 |
...
| `Codigo/ModulosMundo/ControladorPlayer.py` | `ControladorPlayer` | 901 |
...
| `SimuladorServerJogo/Gerais/Rotas/Atualizador.py` | 12 | 17 | 743 |
...
| `SimuladorServerJogo/Gerais/EstadoServidor.py` | `.py` | 1.344 |
...
| `Outros/EditorAnimaçãoAtaques.py` | `.py` | 1.118 |
| `Codigo/Paineis/VisualizadorLog.py` | `.py` | 1.101 |

## 6. Linhas por extensão

![Gráfico de barras das linhas por extensão](../Imagens/2026-05-07_22-39-38/linhas_por_extensao_barras.png)

![Gráfico de pizza das linhas por extensão](../Imagens/2026-05-07_22-39-38/linhas_por_extensao_pizza.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 71.248 | 73.07% | 240 | 3.08 MB |
| `.json` | 7.391 | 7.58% | 54 | 182.20 KB |
| `.js` | 4.692 | 4.81% | 23 | 186.35 KB |
| `.css` | 4.342 | 4.45% | 14 | 105.62 KB |
| `.java` | 4.254 | 4.36% | 8 | 161.53 KB |
| `.astro` | 2.237 | 2.29% | 42 | 92.09 KB |
| `.csv` | 1.985 | 2.04% | 10 | 246.83 KB |
| `.toml` | 1.194 | 1.22% | 15 | 25.29 KB |
| `.md` | 157 | 0.16% | 1 | 7.07 KB |

## 7. Peso por extensão

![Gráfico de barras do peso por extensão - Top 12](../Imagens/2026-05-07_22-39-38/peso_por_extensao_barras_top12.png)

![Gráfico de pizza do peso por categoria](../Imagens/2026-05-07_22-39-38/peso_por_categoria_pizza.png)

| Ext | Arquivos | Peso | % do jogo |
|---:|---:|---:|---:|
| `.png` | 72.975 | 939.66 MB | 87.70% |
| `.ogg` | 35 | 90.64 MB | 8.46% |
| `.webp` | 741 | 25.20 MB | 2.35% |
| `.mp3` | 6 | 3.97 MB | 0.37% |
| `.wav` | 9 | 3.81 MB | 0.36% |
| `.jpg` | 23 | 3.61 MB | 0.34% |
| `.py` | 240 | 3.08 MB | 0.29% |
| `.ttf` | 3 | 320.02 KB | 0.03% |
| `.csv` | 10 | 246.83 KB | 0.02% |
| `.js` | 23 | 186.35 KB | 0.02% |
| `.json` | 54 | 182.20 KB | 0.02% |
| `.java` | 8 | 161.53 KB | 0.01% |
| `.class` | 33 | 135.55 KB | 0.01% |
| `.css` | 14 | 105.62 KB | 0.01% |
| `.astro` | 42 | 92.09 KB | 0.01% |
| `.glsl` | 25 | 46.73 KB | 0.00% |
| `.toml` | 15 | 25.29 KB | 0.00% |
...
|---|---:|---:|---:|
| Arquivos | 74.174 | 74.264 | +90 |
| Linhas | 94.427 | 97.611 | +3.184 |
| Linhas .py | 68.713 | 71.248 | +2.535 |
| Métodos/funções | 3.998 | 4.130 | +132 |
| Classes | 221 | 222 | +1 |
| Commits | 584 | 605 | +21 |
| Tamanho | 914.21 MB | 1.046 GB | +157.25 MB |

### Top 3 commits por tamanho de diff

| Rank | Commit | Mensagem | Arquivos | Adições | Reduções | Diff total |
|---:|---|---|---:|---:|---:|---:|
| 1 | `ac4dd9f76a26` | relatorio | 16 | 5.272 | 848 | 6.120 |
| 2 | `b8f7596949ee` | otimizaÃ§Ã£o de site por componentes | 27 | 989 | 1.039 | 2.028 |
| 3 | `1a2189ad9312` | RefatoraÃ§Ã£o do sistema de alvificaÃ§Ã£o dos ataques (adaptaÃ§Ã£o para multialvo personalizado) | 30 | 1.367 | 439 | 1.806 |

## 9. Gráficos de crescimento

![Crescimento de linhas gerais](../Imagens/2026-05-07_22-39-38/crescimento_linhas_totais.png)

![Crescimento de linhas .py](../Imagens/2026-05-07_22-39-38/crescimento_linhas_py.png)

![Crescimento de arquivos .py](../Imagens/2026-05-07_22-39-38/crescimento_arquivos_py.png)

![Crescimento de commits](../Imagens/2026-05-07_22-39-38/crescimento_commits.png)

![Crescimento de peso do jogo](../Imagens/2026-05-07_22-39-38/crescimento_peso_jogo.png)

...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_daqfq43a`  
**Gerado em:** 2026-05-15T11:31:46  
...
- **Peso dos arquivos de texto:** 4339.32 KB
- **Tamanho total:** 1.075 GB (1.154.022.258 bytes)
- **Dias desde a criação do projeto:** 68
- **Dias desde a criação oficial:** 342
- **Horas estimadas:** 568.00
- **Linhas totais gerais:** 101.337
- **Commits (projeto):** 609

## 2. Python

- **Arquivos `.py`:** 242
- **Linhas totais:** 73.964
- **Tamanho total `.py`:** 3271.89 KB
- **Classes encontradas:** 222
- **Funções encontradas:** 1.176
- **Métodos encontrados:** 3.074
- **Total funções + métodos:** 4.250
- **Bibliotecas diferentes usadas:** 47

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-05-09_01-44-52/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-05-09_01-44-52/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-05-09_01-44-52/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 22 | 168 | 43.417 | 1920.78 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-05-09_01-44-52/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-05-09_01-44-52/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-05-09_01-44-52/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-05-09_01-44-52/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `ModulosMundo` | 1 | 35 | 9.359 | 435.14 |
...
| `SimuladorServerJogo/Gerais/Geradores/GeradorDungeons.py` | 885 | 40.56 |
...
![Gráfico de barras das linhas por extensão](../Imagens/2026-05-09_01-44-52/linhas_por_extensao_barras.png)

![Gráfico de pizza das linhas por extensão](../Imagens/2026-05-09_01-44-52/linhas_por_extensao_pizza.png)

![Crescimento das linhas por extensão](../Imagens/2026-05-09_01-44-52/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 73.964 | 73.04% | 242 | 3.20 MB |
| `.json` | 7.391 | 7.30% | 54 | 186.03 KB |
| `.js` | 4.692 | 4.63% | 23 | 190.04 KB |
| `.css` | 4.342 | 4.29% | 14 | 107.98 KB |
| `.java` | 4.254 | 4.20% | 8 | 161.53 KB |
...
![Gráfico de barras do peso por extensão - Top 12](../Imagens/2026-05-09_01-44-52/peso_por_extensao_barras_top12.png)

![Gráfico de pizza do peso por categoria](../Imagens/2026-05-09_01-44-52/peso_por_categoria_pizza.png)

| Ext | Arquivos | Peso | % do jogo |
|---:|---:|---:|---:|
| `.png` | 72.991 | 968.76 MB | 88.02% |
| `.ogg` | 35 | 90.64 MB | 8.24% |
| `.webp` | 741 | 25.20 MB | 2.29% |
| `.mp3` | 6 | 3.97 MB | 0.36% |
| `.wav` | 9 | 3.81 MB | 0.35% |
| `.jpg` | 23 | 3.61 MB | 0.33% |
| `.py` | 242 | 3.20 MB | 0.29% |
...
![Crescimento de linhas gerais](../Imagens/2026-05-09_01-44-52/crescimento_linhas_totais.png)

![Crescimento de linhas .py](../Imagens/2026-05-09_01-44-52/crescimento_linhas_py.png)

![Crescimento de arquivos .py](../Imagens/2026-05-09_01-44-52/crescimento_arquivos_py.png)

![Crescimento de commits](../Imagens/2026-05-09_01-44-52/crescimento_commits.png)

![Crescimento de peso do jogo](../Imagens/2026-05-09_01-44-52/crescimento_peso_jogo.png)

![Horas estimadas conforme o tempo](../Imagens/2026-05-09_01-44-52/crescimento_horas_estimadas.png)

...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_u4t0n7m0`  
**Gerado em:** 2026-05-15T11:34:15  
...
- **Pastas:** 1.299
- **Arquivos:** 74.349
- **Arquivos de texto:** 437
- **Peso dos arquivos de texto:** 4484.42 KB
- **Tamanho total:** 1.277 GB (1.370.974.035 bytes)
- **Dias desde a criação do projeto:** 69
- **Dias desde a criação oficial:** 343
- **Horas estimadas:** 581.00
- **Linhas totais gerais:** 107.200
- **Commits (projeto):** 626

## 2. Python

- **Arquivos `.py`:** 243
- **Linhas totais:** 74.833
- **Tamanho total `.py`:** 3310.61 KB
- **Classes encontradas:** 223
- **Funções encontradas:** 1.202
- **Métodos encontrados:** 3.107
- **Total funções + métodos:** 4.309
- **Bibliotecas diferentes usadas:** 47

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-05-10_01-17-50/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-05-10_01-17-50/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-05-10_01-17-50/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 22 | 168 | 43.533 | 1926.04 |
| 2 | `Dados` | `Dados` | 6 | 61 | 13.228 | 515.59 |
| 3 | `Site` | `Site/src` | 5 | 79 | 11.271 | 392.25 |
| 4 | `Documentação` | `Documentação` | 0 | 0 | 0 | 0.00 |
| 5 | `BackEnd` | `Servidor + ServidorGeral` | 0 | 0 | 0 | 0.00 |

## 4. Principais pastas

![Gráfico de barras das 12 pastas principais](../Imagens/2026-05-10_01-17-50/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-05-10_01-17-50/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-05-10_01-17-50/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-05-10_01-17-50/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `ModulosMundo` | 1 | 35 | 9.390 | 436.80 |
| 2 | `Ferramentas` | 0 | 12 | 8.684 | 327.64 |
| 3 | `Paineis` | 0 | 16 | 8.388 | 377.83 |
| 4 | `ModulosGerais` | 1 | 31 | 6.732 | 280.80 |
...
| `SimuladorServerJogo/Gerais/EstadoServidor.py` | 1.397 | 60.89 |
...
| `Codigo/Cenas/CenaMundo.py` | 965 | 56.21 |
...
| `SimuladorServerJogo/Mundo/InicializadorNPC.py` | 531 | 27.19 |
...
| `Codigo/ModulosMundo/LeitorDialogo.py` | 498 | 20.67 |
...
| `SimuladorServerJogo/Mundo/Cerebros/CerebroCentral.py` | 485 | 24.98 |
...
![Crescimento das linhas por extensão](../Imagens/2026-05-10_01-17-50/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 74.833 | 69.85% | 243 | 3.23 MB |
| `.json` | 12.404 | 11.58% | 54 | 298.37 KB |
| `.js` | 4.692 | 4.38% | 23 | 190.04 KB |
| `.css` | 4.342 | 4.05% | 14 | 107.98 KB |
| `.java` | 4.254 | 3.97% | 8 | 161.53 KB |
| `.astro` | 2.237 | 2.09% | 42 | 94.23 KB |
| `.csv` | 1.934 | 1.81% | 10 | 240.37 KB |
| `.toml` | 1.226 | 1.14% | 15 | 25.81 KB |
| `.glsl` | 1.010 | 0.94% | 25 | 46.76 KB |
...
![Horas estimadas conforme o tempo](../Imagens/2026-05-10_01-17-50/crescimento_horas_estimadas.png)

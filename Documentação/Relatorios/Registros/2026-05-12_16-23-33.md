...
- **Pastas:** 1.278
- **Arquivos:** 73.984
- **Arquivos de texto:** 418
- **Peso dos arquivos de texto:** 4436.01 KB
- **Tamanho total:** 1.462 GB (1.569.549.004 bytes)
- **Dias desde a criação do projeto:** 71
- **Dias desde a criação oficial:** 345
- **Horas estimadas:** 599.00
- **Linhas totais gerais:** 105.507
- **Commits (projeto):** 641
- **Adições desde o último relatório:** <span style='color: green'>+6.205</span>
- **Reduções desde o último relatório:** <span style='color: red'>-715</span>

## 2. Python

- **Arquivos `.py`:** 242
- **Linhas totais:** 73.169
- **Tamanho total `.py`:** 3239.71 KB
- **Classes encontradas:** 224
- **Funções encontradas:** 1.113
- **Métodos encontrados:** 3.122
- **Total funções + métodos:** 4.235
- **Bibliotecas diferentes usadas:** 47

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-05-12_16-23-33/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-05-12_16-23-33/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Dados` | 6 | 61 | 13.285 | 554.41 |
| 2 | `Site` | 24 | 1.869 | 12.203 | 42000.50 |
| 3 | `ServerGerais` | 4 | 55 | 10.941 | 606.19 |
| 4 | `Paineis` | 0 | 17 | 8.538 | 383.91 |
| 5 | `ServerBatalha` | 1 | 26 | 7.801 | 349.69 |
| 6 | `ServerMundo` | 2 | 26 | 7.115 | 375.51 |
| 7 | `Outros` | 0 | 10 | 6.183 | 232.28 |
| 8 | `Telas` | 2 | 20 | 6.169 | 242.12 |
| 9 | `ModulosBatalha` | 0 | 13 | 5.499 | 264.42 |
| 10 | `ModulosMundo` | 0 | 16 | 5.098 | 241.21 |
| 11 | `ModulosGerais` | 1 | 25 | 4.922 | 188.47 |
| 12 | `ServerLogica` | 4 | 42 | 4.768 | 151.46 |
| 13 | `Geradores` | 1 | 19 | 4.346 | 197.89 |
| 14 | `Prefabs` | 0 | 14 | 3.580 | 131.89 |
| 15 | `Visual` | 0 | 9 | 2.732 | 119.68 |
| 16 | `Cenas` | 0 | 6 | 1.898 | 95.41 |
...
| `SimuladorServerJogo/Batalha/PokemonBatalha.py` | 1.133 | 58.26 |
...
| `SimuladorServerJogo/Batalha/Partida.py` | 1.029 | 50.97 |
| `Codigo/Cenas/CenaMundo.py` | 976 | 56.74 |
| `SimuladorServerJogo/Gerais/Geradores/GeradorPokemon.py` | 926 | 38.57 |
| `Codigo/ModulosMundo/ControladorPlayer.py` | 923 | 45.52 |
| `SimuladorServerJogo/Mundo/Cerebros/CerebroDungeons.py` | 919 | 53.56 |
...
| `Codigo/ModulosBatalha/ControladorAnimacoes.py` | 694 | 35.08 |
...
| `Codigo/Paineis/FichaPokemonBatalha.py` | 670 | 33.12 |
...
| `SimuladorServerJogo/Gerais/Rotas/Ativador.py` | 568 | 28.19 |
...
| `Codigo/ModulosBatalha/PokemonBatalha.py` | 509 | 24.26 |
...
| `SimuladorServerJogo/Batalha/RodadorTurno.py` | 492 | 25.53 |
| `SimuladorServerJogo/Mundo/Cerebros/CerebroCentral.py` | 492 | 25.65 |
| `SimuladorServerJogo/Logica/Executes/ExecutesAtaques/ExecutesNormal.py` | 491 | 20.82 |
...
| `SimuladorServerJogo/Batalha/PokemonBatalha.py` | `PokemonBatalha` | 1.069 |
| `Codigo/Telas/Subtelas/SubtelaInventarioPokemons.py` | `InventarioPokemons` | 1.066 |
| `SimuladorServerJogo/Batalha/Partida.py` | `Partida` | 985 |
...
| `Codigo/Paineis/FichaPokemonBatalha.py` | `FichaPokemonBatalha` | 650 |
...
| `SimuladorServerJogo/Batalha/Partida.py` | 11 | 19 | 1.029 |
...
| `SimuladorServerJogo/Batalha/PokemonBatalha.py` | `.py` | 1.133 |

## 6. Linhas por extensão

![Gráfico de barras das linhas por extensão](../Imagens/2026-05-12_16-23-33/linhas_por_extensao_barras.png)

![Gráfico de pizza das linhas por extensão](../Imagens/2026-05-12_16-23-33/linhas_por_extensao_pizza.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 73.169 | 69.42% | 242 | 3.16 MB |
| `.json` | 12.315 | 11.68% | 54 | 298.34 KB |
| `.js` | 5.129 | 4.87% | 26 | 207.38 KB |
| `.css` | 4.664 | 4.43% | 15 | 115.89 KB |
| `.java` | 4.254 | 4.04% | 8 | 161.54 KB |
| `.astro` | 2.395 | 2.27% | 45 | 99.73 KB |
| `.csv` | 2.080 | 1.97% | 10 | 278.78 KB |
| `.toml` | 1.233 | 1.17% | 15 | 25.96 KB |
| `.md` | 157 | 0.15% | 1 | 7.07 KB |

## 7. Peso por extensão

![Gráfico de barras do peso por extensão - Top 12](../Imagens/2026-05-12_16-23-33/peso_por_extensao_barras_top12.png)

![Gráfico de pizza do peso por categoria](../Imagens/2026-05-12_16-23-33/peso_por_categoria_pizza.png)

| Ext | Arquivos | Peso | % do jogo |
|---:|---:|---:|---:|
| `.png` | 72.440 | 1.146 GB | 78.42% |
| `.mp3` | 25 | 181.46 MB | 12.12% |
| `.ogg` | 36 | 92.81 MB | 6.20% |
| `.webp` | 967 | 36.48 MB | 2.44% |
| `.wav` | 9 | 3.81 MB | 0.25% |
| `.jpg` | 23 | 3.61 MB | 0.24% |
| `.py` | 242 | 3.16 MB | 0.21% |
| `.ttf` | 3 | 320.02 KB | 0.02% |
| `.json` | 54 | 298.34 KB | 0.02% |
| `.csv` | 10 | 278.78 KB | 0.02% |
| `.js` | 26 | 207.38 KB | 0.01% |
| `.java` | 8 | 161.54 KB | 0.01% |
| `.class` | 33 | 135.56 KB | 0.01% |
| `.css` | 15 | 115.89 KB | 0.01% |
| `.astro` | 45 | 99.73 KB | 0.01% |
| `.glsl` | 25 | 46.73 KB | 0.00% |
| `.toml` | 15 | 25.96 KB | 0.00% |
...
|---|---:|---:|---:|
| Arquivos | 73.985 | 73.984 | -1 |
| Linhas | 104.958 | 105.507 | +549 |
| Linhas .py | 72.616 | 73.169 | +553 |
| Métodos/funções | 4.212 | 4.235 | +23 |
| Classes | 224 | 224 | 0 |
| Commits | 636 | 641 | +5 |
| Tamanho | 1.463 GB | 1.462 GB | -1.76 MB |

### Top 3 commits por tamanho de diff

| Rank | Commit | Mensagem | Arquivos | Adições | Reduções | Diff total |
|---:|---|---|---:|---:|---:|---:|
| 1 | `71acafe48c3b` | relatorio | 16 | 5.050 | 109 | 5.159 |
| 2 | `fcd026378737` | Inicio da grande implementaÃ§Ã£o dos ataques (normais) | 8 | 514 | 463 | 977 |
| 3 | `e6b9d7ac6e0d` | Novas musicas registradas e alocadas | 7 | 339 | 30 | 369 |

## 9. Gráficos de crescimento

![Crescimento de linhas gerais](../Imagens/2026-05-12_16-23-33/crescimento_linhas_totais.png)

![Crescimento de linhas .py](../Imagens/2026-05-12_16-23-33/crescimento_linhas_py.png)

![Crescimento de arquivos .py](../Imagens/2026-05-12_16-23-33/crescimento_arquivos_py.png)

![Crescimento de commits](../Imagens/2026-05-12_16-23-33/crescimento_commits.png)

![Crescimento de peso do jogo](../Imagens/2026-05-12_16-23-33/crescimento_peso_jogo.png)

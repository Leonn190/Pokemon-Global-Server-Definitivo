...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_rl5poz82`  
**Gerado em:** 2026-05-15T11:39:38  
...
- **Pastas:** 1.279
- **Arquivos:** 73.953
- **Arquivos de texto:** 445
- **Peso dos arquivos de texto:** 4602.06 KB
- **Tamanho total:** 1.462 GB (1.569.532.404 bytes)
- **Dias desde a criação do projeto:** 71
- **Dias desde a criação oficial:** 345
- **Horas estimadas:** 599.00
- **Linhas totais gerais:** 109.095
- **Commits (projeto):** 641

## 2. Python

- **Arquivos `.py`:** 244
- **Linhas totais:** 75.747
- **Tamanho total `.py`:** 3352.21 KB
- **Classes encontradas:** 224
- **Funções encontradas:** 1.229
- **Métodos encontrados:** 3.122
- **Total funções + métodos:** 4.351
- **Bibliotecas diferentes usadas:** 47

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-05-12_16-23-33/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-05-12_16-23-33/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-05-12_16-23-33/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 22 | 169 | 43.875 | 1941.22 |
| 2 | `Dados` | `Dados` | 6 | 61 | 13.285 | 557.91 |
| 3 | `Site` | `Site/src` | 6 | 86 | 12.188 | 425.80 |
| 4 | `Documentação` | `Documentação` | 0 | 0 | 0 | 0.00 |
| 5 | `BackEnd` | `Servidor + ServidorGeral` | 0 | 0 | 0 | 0.00 |

## 4. Principais pastas

![Gráfico de barras das 12 pastas principais](../Imagens/2026-05-12_16-23-33/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-05-12_16-23-33/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-05-12_16-23-33/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-05-12_16-23-33/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `ModulosMundo` | 1 | 35 | 9.444 | 439.57 |
| 2 | `Ferramentas` | 0 | 12 | 8.761 | 330.13 |
| 3 | `Paineis` | 0 | 17 | 8.538 | 384.07 |
| 4 | `ModulosGerais` | 1 | 31 | 6.820 | 284.25 |
| 5 | `Telas` | 2 | 20 | 6.169 | 245.92 |
| 6 | `ModulosBatalha` | 0 | 13 | 5.499 | 266.37 |
...
| `SimuladorServerJogo/Batalha/PokemonBatalha.py` | 1.133 | 58.79 |
...
| `SimuladorServerJogo/Batalha/Partida.py` | 1.029 | 51.28 |
...
| `Codigo/Paineis/FichaPokemonBatalha.py` | 670 | 33.15 |
...
| `SimuladorServerJogo/Batalha/RodadorTurno.py` | 492 | 25.72 |
...
![Crescimento das linhas por extensão](../Imagens/2026-05-12_16-23-33/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 75.747 | 69.48% | 244 | 3.27 MB |
| `.json` | 12.315 | 11.30% | 54 | 302.28 KB |
| `.js` | 5.129 | 4.70% | 26 | 208.48 KB |
| `.css` | 4.664 | 4.28% | 15 | 115.94 KB |
| `.java` | 4.254 | 3.90% | 8 | 161.54 KB |
| `.astro` | 2.395 | 2.20% | 45 | 101.38 KB |
| `.csv` | 2.080 | 1.91% | 10 | 278.78 KB |
| `.toml` | 1.233 | 1.13% | 15 | 25.98 KB |
| `.glsl` | 1.010 | 0.93% | 25 | 46.76 KB |
...
| `.json` | 54 | 302.28 KB | 0.02% |
| `.csv` | 10 | 278.78 KB | 0.02% |
| `.js` | 26 | 208.48 KB | 0.01% |
| `.java` | 8 | 161.54 KB | 0.01% |
| `.css` | 15 | 115.94 KB | 0.01% |
| `.astro` | 45 | 101.38 KB | 0.01% |
...
![Horas estimadas conforme o tempo](../Imagens/2026-05-12_16-23-33/crescimento_horas_estimadas.png)

...
- **Peso dos arquivos de texto:** 4674.66 KB
- **Tamanho total:** 1.730 GB (1.857.256.543 bytes)
- **Dias desde a criação do projeto:** 72
- **Dias desde a criação oficial:** 346
- **Horas estimadas:** 607.00
- **Linhas totais gerais:** 110.695
- **Commits (projeto):** 658
- **Adições desde o último relatório:** <span style='color: green'>+10.890</span>
- **Reduções desde o último relatório:** <span style='color: red'>-997</span>

## 2. Python

- **Arquivos `.py`:** 242
- **Linhas totais:** 76.200
- **Tamanho total `.py`:** 3377.97 KB
- **Classes encontradas:** 224
- **Funções encontradas:** 1.300
- **Métodos encontrados:** 3.130
- **Total funções + métodos:** 4.430
- **Bibliotecas diferentes usadas:** 47

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-05-13_02-11-32/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-05-13_02-11-32/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Dados` | 6 | 61 | 14.160 | 613.46 |
| 2 | `Site` | 32 | 1.934 | 12.955 | 322749.83 |
| 3 | `ServerGerais` | 4 | 55 | 10.941 | 606.19 |
| 4 | `Paineis` | 0 | 17 | 8.596 | 386.53 |
| 5 | `ServerBatalha` | 1 | 26 | 8.452 | 374.31 |
| 6 | `ServerLogica` | 4 | 42 | 7.588 | 278.60 |
| 7 | `ServerMundo` | 2 | 26 | 7.115 | 375.51 |
| 8 | `Outros` | 0 | 10 | 6.193 | 232.68 |
| 9 | `Telas` | 2 | 20 | 6.169 | 242.12 |
| 10 | `ModulosBatalha` | 0 | 13 | 5.521 | 265.63 |
| 11 | `ModulosMundo` | 0 | 16 | 5.098 | 241.21 |
| 12 | `ModulosGerais` | 1 | 25 | 4.922 | 188.47 |
...
| `SimuladorServerJogo/Batalha/PokemonBatalha.py` | 1.152 | 59.48 |
...
| `SimuladorServerJogo/Batalha/Partida.py` | 1.055 | 52.43 |
...
| `Codigo/Paineis/FichaPokemonBatalha.py` | 725 | 35.51 |
...
| `SimuladorServerJogo/Batalha/RodadorTurno.py` | 541 | 28.44 |
...
| `SimuladorServerJogo/Logica/Executes/ExecutesAtaques/UtilitariosExecutes.py` | 518 | 22.64 |
...
| `SimuladorServerJogo/Batalha/PokemonBatalha.py` | `.py` | 1.152 |
...
|---:|---:|---:|---:|---:|
| `.py` | 76.200 | 68.91% | 242 | 3.30 MB |
| `.json` | 13.720 | 12.41% | 54 | 375.15 KB |
| `.js` | 5.545 | 5.01% | 28 | 221.94 KB |
| `.css` | 4.893 | 4.42% | 16 | 120.84 KB |
| `.java` | 4.254 | 3.85% | 8 | 161.54 KB |
| `.astro` | 2.502 | 2.26% | 49 | 103.81 KB |
| `.csv` | 2.080 | 1.88% | 10 | 278.78 KB |
| `.toml` | 1.233 | 1.11% | 15 | 25.96 KB |
...
|---|---:|---:|---:|
| Arquivos | 73.984 | 74.049 | +65 |
| Linhas | 105.507 | 110.695 | +5.188 |
| Linhas .py | 73.169 | 76.200 | +3.031 |
| Métodos/funções | 4.235 | 4.430 | +195 |
| Classes | 224 | 224 | 0 |
| Commits | 641 | 658 | +17 |
| Tamanho | 1.462 GB | 1.730 GB | +274.38 MB |

### Top 3 commits por tamanho de diff

| Rank | Commit | Mensagem | Arquivos | Adições | Reduções | Diff total |
|---:|---|---|---:|---:|---:|---:|
| 1 | `b5836d6feb89` | relatorio | 16 | 4.860 | 155 | 5.015 |
| 2 | `46381f545411` | ataques tipo lutador 1/2 | 4 | 886 | 77 | 963 |
| 3 | `56192b602eba` | novas wikis e wiki de musicas pronta p site | 11 | 811 | 79 | 890 |

...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_ss0in2_u`  
**Gerado em:** 2026-05-15T11:44:48  
...
- **Peso dos arquivos de texto:** 4979.98 KB
- **Tamanho total:** 1.730 GB (1.857.409.726 bytes)
- **Dias desde a criação do projeto:** 72
- **Dias desde a criação oficial:** 346
- **Horas estimadas:** 616.50
- **Linhas totais gerais:** 117.600
- **Commits (projeto):** 667

## 2. Python

- **Arquivos `.py`:** 245
- **Linhas totais:** 80.463
- **Tamanho total `.py`:** 3575.97 KB
- **Classes encontradas:** 224
- **Funções encontradas:** 1.526
- **Métodos encontrados:** 3.132
- **Total funções + métodos:** 4.658
- **Bibliotecas diferentes usadas:** 47

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-05-13_13-32-38/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-05-13_13-32-38/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-05-13_13-32-38/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 22 | 170 | 44.170 | 1957.56 |
| 2 | `Dados` | `Dados` | 6 | 61 | 14.703 | 640.56 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-05-13_13-32-38/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-05-13_13-32-38/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-05-13_13-32-38/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-05-13_13-32-38/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `ModulosMundo` | 1 | 35 | 9.589 | 450.66 |
| 2 | `Ferramentas` | 0 | 12 | 8.752 | 330.05 |
...
| `SimuladorServerJogo/Batalha/RodadorTurno.py` | 541 | 28.67 |
...
| `SimuladorServerJogo/Logica/Executes/ExecutesAtaques/UtilitariosExecutes.py` | 523 | 23.26 |
...
![Crescimento das linhas por extensão](../Imagens/2026-05-13_13-32-38/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 80.463 | 68.46% | 245 | 3.49 MB |
| `.json` | 14.423 | 12.27% | 54 | 408.71 KB |
| `.js` | 5.545 | 4.72% | 28 | 223.46 KB |
| `.css` | 4.893 | 4.16% | 16 | 121.11 KB |
| `.java` | 4.254 | 3.62% | 8 | 161.54 KB |
| `.astro` | 2.502 | 2.13% | 49 | 105.63 KB |
| `.toml` | 2.162 | 1.84% | 16 | 49.30 KB |
| `.csv` | 2.080 | 1.77% | 10 | 278.79 KB |
| `.glsl` | 1.010 | 0.86% | 25 | 46.76 KB |
...
| `.jpg` | 23 | 3.61 MB | 0.20% |
| `.py` | 245 | 3.49 MB | 0.20% |
| `.json` | 54 | 408.71 KB | 0.02% |
| `.ttf` | 3 | 320.02 KB | 0.02% |
| `.csv` | 10 | 278.79 KB | 0.02% |
...
![Horas estimadas conforme o tempo](../Imagens/2026-05-13_13-32-38/crescimento_horas_estimadas.png)

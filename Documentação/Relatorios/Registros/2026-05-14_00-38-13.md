...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_9rdeg7jn`  
**Gerado em:** 2026-05-15T11:47:32  
...
- **Pastas:** 1.287
- **Arquivos:** 74.031
- **Arquivos de texto:** 454
- **Peso dos arquivos de texto:** 5190.26 KB
- **Tamanho total:** 1.788 GB (1.919.873.605 bytes)
- **Dias desde a criação do projeto:** 73
- **Dias desde a criação oficial:** 347
- **Horas estimadas:** 625.50
- **Linhas totais gerais:** 123.351
- **Commits (projeto):** 676

## 2. Python

- **Arquivos `.py`:** 245
- **Linhas totais:** 82.098
- **Tamanho total `.py`:** 3648.63 KB
- **Classes encontradas:** 224
- **Funções encontradas:** 1.621
- **Métodos encontrados:** 3.132
- **Total funções + métodos:** 4.753
- **Bibliotecas diferentes usadas:** 47

## 3. Macro áreas

![Gráfico de barras das macro áreas](../Imagens/2026-05-14_00-38-13/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-05-14_00-38-13/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-05-14_00-38-13/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `FrontEnd` | `Codigo + Game.py` | 22 | 170 | 44.170 | 1957.56 |
| 2 | `Dados` | `Dados` | 6 | 61 | 18.669 | 772.97 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-05-14_00-38-13/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-05-14_00-38-13/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-05-14_00-38-13/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-05-14_00-38-13/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `ModulosMundo` | 1 | 35 | 9.589 | 450.66 |
| 2 | `Ferramentas` | 0 | 12 | 8.769 | 330.39 |
| 3 | `Paineis` | 0 | 17 | 8.366 | 375.03 |
| 4 | `ModulosGerais` | 1 | 32 | 7.093 | 295.45 |
| 5 | `Telas` | 2 | 20 | 6.188 | 246.87 |
| 6 | `ModulosBatalha` | 0 | 13 | 5.526 | 268.34 |
...
| `SimuladorServerJogo/Gerais/EstadoServidor.py` | 1.485 | 65.22 |
...
| `SimuladorServerJogo/Batalha/PokemonBatalha.py` | 1.190 | 61.58 |
...
| `SimuladorServerJogo/Batalha/Partida.py` | 1.060 | 53.35 |
| `Codigo/Cenas/CenaMundo.py` | 978 | 57.09 |
| `SimuladorServerJogo/Logica/Executes/ExecutesAtaques/UtilitariosExecutes.py` | 968 | 42.67 |
| `Codigo/ModulosMundo/ControladorPlayer.py` | 931 | 46.06 |
| `SimuladorServerJogo/Mundo/Cerebros/CerebroDungeons.py` | 929 | 54.84 |
...
| `SimuladorServerJogo/Batalha/RodadorTurno.py` | 556 | 29.37 |
...
| `Codigo/Geradores/Player/Perfil.py` | 519 | 29.46 |
...
![Crescimento das linhas por extensão](../Imagens/2026-05-14_00-38-13/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 82.098 | 66.60% | 245 | 3.56 MB |
| `.json` | 18.539 | 15.04% | 54 | 546.33 KB |
| `.js` | 5.545 | 4.50% | 28 | 223.46 KB |
| `.css` | 4.893 | 3.97% | 16 | 121.11 KB |
| `.java` | 4.254 | 3.45% | 8 | 161.54 KB |
| `.astro` | 2.502 | 2.03% | 49 | 105.63 KB |
| `.toml` | 2.162 | 1.75% | 16 | 49.30 KB |
| `.csv` | 2.080 | 1.69% | 10 | 278.79 KB |
| `.glsl` | 1.010 | 0.82% | 25 | 46.76 KB |
...
![Horas estimadas conforme o tempo](../Imagens/2026-05-14_00-38-13/crescimento_horas_estimadas.png)

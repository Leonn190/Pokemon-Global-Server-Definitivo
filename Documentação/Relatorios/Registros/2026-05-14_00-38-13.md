...
- **Peso dos arquivos de texto:** 5010.31 KB
- **Tamanho total:** 1.788 GB (1.919.875.965 bytes)
- **Dias desde a criação do projeto:** 73
- **Dias desde a criação oficial:** 347
- **Horas estimadas:** 625.50
- **Linhas totais gerais:** 119.763
- **Commits (projeto):** 676
- **Adições desde o último relatório:** <span style='color: green'>+11.068</span>
- **Reduções desde o último relatório:** <span style='color: red'>-517</span>

## 2. Python

- **Arquivos `.py`:** 243
- **Linhas totais:** 79.520
- **Tamanho total `.py`:** 3529.60 KB
- **Classes encontradas:** 224
- **Funções encontradas:** 1.505
- **Métodos encontrados:** 3.132
- **Total funções + métodos:** 4.637
- **Bibliotecas diferentes usadas:** 47

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-05-14_00-38-13/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-05-14_00-38-13/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Dados` | 6 | 61 | 18.669 | 764.64 |
| 2 | `Site` | 32 | 1.934 | 12.955 | 322749.83 |
| 3 | `ServerLogica` | 4 | 43 | 11.406 | 429.42 |
| 4 | `ServerGerais` | 4 | 55 | 11.071 | 612.57 |
| 5 | `ServerBatalha` | 1 | 26 | 8.820 | 387.44 |
| 6 | `Paineis` | 0 | 17 | 8.366 | 374.45 |
| 7 | `ServerMundo` | 2 | 26 | 7.145 | 378.19 |
| 8 | `Outros` | 0 | 10 | 6.191 | 232.68 |
| 9 | `Telas` | 2 | 20 | 6.188 | 243.06 |
...
| `SimuladorServerJogo/Logica/Executes/ExecutesAtaques/UtilitariosExecutes.py` | 968 | 41.94 |
...
| `SimuladorServerJogo/Batalha/RodadorTurno.py` | 556 | 29.12 |
...
| `SimuladorServerJogo/Batalha/RodadorTurno.py` | `RodadorTurno` | 547 |
...
![Gráfico de barras das linhas por extensão](../Imagens/2026-05-14_00-38-13/linhas_por_extensao_barras.png)

![Gráfico de pizza das linhas por extensão](../Imagens/2026-05-14_00-38-13/linhas_por_extensao_pizza.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 79.520 | 66.46% | 243 | 3.45 MB |
| `.json` | 18.539 | 15.49% | 54 | 537.06 KB |
| `.js` | 5.545 | 4.63% | 28 | 221.94 KB |
| `.css` | 4.893 | 4.09% | 16 | 120.84 KB |
| `.java` | 4.254 | 3.56% | 8 | 161.54 KB |
| `.astro` | 2.502 | 2.09% | 49 | 103.81 KB |
| `.toml` | 2.162 | 1.81% | 16 | 48.37 KB |
| `.csv` | 2.080 | 1.74% | 10 | 278.46 KB |
| `.md` | 157 | 0.13% | 1 | 7.07 KB |

## 7. Peso por extensão

![Gráfico de barras do peso por extensão - Top 12](../Imagens/2026-05-14_00-38-13/peso_por_extensao_barras_top12.png)

![Gráfico de pizza do peso por categoria](../Imagens/2026-05-14_00-38-13/peso_por_categoria_pizza.png)

| Ext | Arquivos | Peso | % do jogo |
|---:|---:|---:|---:|
| `.png` | 72.441 | 1.146 GB | 64.11% |
| `.mp3` | 57 | 422.16 MB | 23.06% |
| `.ogg` | 72 | 185.63 MB | 10.14% |
| `.webp` | 967 | 36.48 MB | 1.99% |
| `.wav` | 9 | 3.81 MB | 0.21% |
| `.jpg` | 23 | 3.61 MB | 0.20% |
| `.py` | 243 | 3.45 MB | 0.19% |
| `.json` | 54 | 537.06 KB | 0.03% |
...
|---|---:|---:|---:|
| Arquivos | 74.052 | 74.062 | +10 |
| Linhas | 114.012 | 119.763 | +5.751 |
| Linhas .py | 77.885 | 79.520 | +1.635 |
| Métodos/funções | 4.542 | 4.637 | +95 |
| Classes | 224 | 224 | 0 |
| Commits | 667 | 676 | +9 |
| Tamanho | 1.730 GB | 1.788 GB | +59.57 MB |

### Top 3 commits por tamanho de diff

| Rank | Commit | Mensagem | Arquivos | Adições | Reduções | Diff total |
|---:|---|---|---:|---:|---:|---:|
| 1 | `6f2085177d1c` | relatorio | 16 | 4.910 | 110 | 5.020 |
| 2 | `a4f5da70c8f6` | primeiros dialogos reais (alleka garcia e felipox) | 3 | 3.624 | 128 | 3.752 |
| 3 | `aed2242e9fc2` | ataques fantasma | 4 | 780 | 108 | 888 |

## 9. Gráficos de crescimento

![Crescimento de linhas gerais](../Imagens/2026-05-14_00-38-13/crescimento_linhas_totais.png)

![Crescimento de linhas .py](../Imagens/2026-05-14_00-38-13/crescimento_linhas_py.png)

![Crescimento de arquivos .py](../Imagens/2026-05-14_00-38-13/crescimento_arquivos_py.png)

![Crescimento de commits](../Imagens/2026-05-14_00-38-13/crescimento_commits.png)

![Crescimento de peso do jogo](../Imagens/2026-05-14_00-38-13/crescimento_peso_jogo.png)

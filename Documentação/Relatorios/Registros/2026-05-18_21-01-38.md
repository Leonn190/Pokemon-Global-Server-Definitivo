...
- **Commits (projeto):** 736
- **Adições desde o último relatório:** <span style='color: green'>+22.794</span>
- **Reduções desde o último relatório:** <span style='color: red'>-399</span>

## 2. Python

- **Arquivos `.py`:** 270
- **Linhas totais:** 86.387
...
![Gráfico de barras das macro áreas](../Imagens/2026-05-18_21-01-38/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-05-18_21-01-38/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-05-18_21-01-38/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `Dados` | `Dados` | 17 | 177 | 74.584 | 2220.74 |
| 2 | `FrontEnd` | `Codigo + Game.py` | 20 | 186 | 47.018 | 2046.95 |
...
![Gráfico de barras das 12 pastas principais](../Imagens/2026-05-18_21-01-38/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-05-18_21-01-38/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-05-18_21-01-38/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-05-18_21-01-38/pastas_principais_crescimento_bottom6.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `ServerGerais` | 4 | 57 | 12.151 | 652.44 |
| 2 | `ServerLogica` | 3 | 29 | 10.347 | 436.85 |
| 3 | `ModulosMundo` | 2 | 42 | 9.921 | 462.05 |
| 4 | `Paineis` | 0 | 18 | 8.739 | 390.24 |
| 5 | `ServerBatalha` | 1 | 28 | 7.851 | 363.74 |
| 6 | `ModulosGerais` | 2 | 36 | 7.651 | 317.22 |
| 7 | `Telas` | 2 | 22 | 7.428 | 292.82 |
...
![Gráfico de barras das linhas por extensão](../Imagens/2026-05-18_21-01-38/linhas_por_extensao_barras.png)

![Gráfico de pizza das linhas por extensão](../Imagens/2026-05-18_21-01-38/linhas_por_extensao_pizza.png)

![Crescimento das linhas por extensão](../Imagens/2026-05-18_21-01-38/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 86.387 | 46.78% | 270 | 3.71 MB |
| `.json` | 70.252 | 38.05% | 149 | 1.85 MB |
| `.js` | 6.486 | 3.51% | 32 | 258.43 KB |
| `.css` | 5.371 | 2.91% | 17 | 132.90 KB |
| `.java` | 4.254 | 2.30% | 8 | 161.54 KB |
| `.astro` | 2.960 | 1.60% | 50 | 121.76 KB |
| `.md` | 2.826 | 1.53% | 49 | 71.94 KB |
| `.toml` | 2.265 | 1.23% | 16 | 50.17 KB |
| `.csv` | 2.082 | 1.13% | 10 | 278.53 KB |
| `.glsl` | 1.095 | 0.59% | 25 | 51.82 KB |
| `.mmd` | 630 | 0.34% | 45 | 22.50 KB |
| `.yml` | 39 | 0.02% | 1 | 605 bytes |

## 8. Peso por extensão

![Gráfico de barras do peso por extensão - Top 12](../Imagens/2026-05-18_21-01-38/peso_por_extensao_barras_top12.png)

![Gráfico de pizza do peso por categoria](../Imagens/2026-05-18_21-01-38/peso_por_categoria_pizza.png)

| Ext | Arquivos | Peso | % do jogo |
|---:|---:|---:|---:|
| `.png` | 72.441 | 1.146 GB | 59.69% |
...
|---|---:|---:|---:|
| Arquivos | 74.269 | 74.304 | +35 |
| Linhas | 167.581 | 184.719 | +17.138 |
| Linhas .py | 86.068 | 86.387 | +319 |
| Métodos/funções | 5.098 | 5.118 | +20 |
| Classes | 248 | 248 | 0 |
| Commits | 725 | 736 | +11 |
| Tamanho | 1.920 GB | 1.921 GB | +429.17 KB |

### Top 3 commits por tamanho de diff

| Rank | Commit | Mensagem | Arquivos | Adições | Reduções | Diff total |
|---:|---|---|---:|---:|---:|---:|
| 1 | `0f47dc5d83e2` | dialogos 10 | 13 | 7.636 | 0 | 7.636 |
| 2 | `58f916ed8afe` | relatorio | 40 | 5.402 | 145 | 5.547 |
| 3 | `ec72d0466d6b` | dialogos 8 | 5 | 2.265 | 0 | 2.265 |

## 10. Gráficos de crescimento

![Crescimento de linhas gerais](../Imagens/2026-05-18_21-01-38/crescimento_linhas_totais.png)

![Crescimento de linhas .py](../Imagens/2026-05-18_21-01-38/crescimento_linhas_py.png)

![Crescimento de arquivos .py](../Imagens/2026-05-18_21-01-38/crescimento_arquivos_py.png)

![Crescimento de commits](../Imagens/2026-05-18_21-01-38/crescimento_commits.png)

![Crescimento de peso do jogo](../Imagens/2026-05-18_21-01-38/crescimento_peso_jogo.png)

![Horas estimadas conforme o tempo](../Imagens/2026-05-18_21-01-38/crescimento_horas_estimadas.png)

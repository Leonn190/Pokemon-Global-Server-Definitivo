...
- **Dias desde a criação do projeto:** 79
- **Dias desde a criação oficial:** 353
- **Horas estimadas:** 637.00
- **Linhas totais gerais:** 198.855
- **Commits (projeto):** 755
- **Adições desde o último relatório:** <span style='color: green'>+12.312</span>
- **Reduções desde o último relatório:** <span style='color: red'>-1.393</span>

## 2. Python

- **Arquivos `.py`:** 275
- **Linhas totais:** 88.092
...
![Gráfico de barras das macro áreas](../Imagens/2026-05-20_21-53-32/macro_areas_barras.png)

![Gráfico de pizza das macro áreas](../Imagens/2026-05-20_21-53-32/macro_areas_pizza.png)

![Crescimento das macro áreas](../Imagens/2026-05-20_21-53-32/macro_areas_crescimento.png)

| Rank | Área | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `Dados` | `Dados` | 17 | 177 | 86.432 | 2394.81 |
| 2 | `FrontEnd` | `Codigo + Game.py` | 20 | 191 | 48.937 | 2139.29 |
| 3 | `BackEnd` | `Servidor + ServidorGeral` | 14 | 144 | 37.772 | 1841.52 |
| 4 | `Site` | `Site/src` | 6 | 99 | 15.001 | 520.32 |
| 5 | `Documentação` | `Documentação` | 91 | 90 | 3.060 | 75.77 |

## 4. Principais pastas

![Gráfico de barras das 12 pastas principais](../Imagens/2026-05-20_21-53-32/rank_12_pastas_barras.png)

![Gráfico de pizza das 12 pastas principais](../Imagens/2026-05-20_21-53-32/rank_12_pastas_pizza.png)

![Crescimento das 6 maiores pastas principais](../Imagens/2026-05-20_21-53-32/pastas_principais_crescimento_top6.png)

![Crescimento das 6 menores pastas principais](../Imagens/2026-05-20_21-53-32/pastas_principais_crescimento_bottom6.png)
...
| 6 | `ModulosGerais` | 2 | 36 | 7.863 | 326.01 |
...
![Gráfico de barras das linhas por extensão](../Imagens/2026-05-20_21-53-32/linhas_por_extensao_barras.png)

![Gráfico de pizza das linhas por extensão](../Imagens/2026-05-20_21-53-32/linhas_por_extensao_pizza.png)

![Crescimento das linhas por extensão](../Imagens/2026-05-20_21-53-32/linhas_por_extensao_crescimento.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 88.092 | 44.32% | 275 | 3.79 MB |
| `.json` | 82.100 | 41.30% | 149 | 2.02 MB |
| `.js` | 6.589 | 3.31% | 32 | 263.00 KB |
| `.css` | 5.401 | 2.72% | 17 | 133.48 KB |
| `.java` | 4.254 | 2.14% | 8 | 161.54 KB |
| `.astro` | 3.011 | 1.51% | 50 | 123.84 KB |
| `.md` | 2.826 | 1.42% | 49 | 71.94 KB |
| `.toml` | 2.265 | 1.14% | 16 | 50.17 KB |
| `.csv` | 2.082 | 1.05% | 10 | 278.53 KB |
| `.glsl` | 1.494 | 0.75% | 28 | 72.62 KB |
| `.mmd` | 630 | 0.32% | 45 | 22.50 KB |
| `.yml` | 39 | 0.02% | 1 | 605 bytes |

## 8. Peso por extensão

![Gráfico de barras do peso por extensão - Top 12](../Imagens/2026-05-20_21-53-32/peso_por_extensao_barras_top12.png)

![Gráfico de pizza do peso por categoria](../Imagens/2026-05-20_21-53-32/peso_por_categoria_pizza.png)
...
| `.py` | 275 | 3.79 MB | 0.19% |
| `.jpg` | 23 | 3.61 MB | 0.18% |
| `.json` | 149 | 2.02 MB | 0.10% |
| `.ttf` | 3 | 320.02 KB | 0.02% |
| `.csv` | 10 | 278.53 KB | 0.01% |
| `.js` | 32 | 263.00 KB | 0.01% |
...
|---|---:|---:|---:|
| Arquivos | 74.308 | 74.312 | +4 |
| Linhas | 193.290 | 198.855 | +5.565 |
| Linhas .py | 87.691 | 88.092 | +401 |
| Métodos/funções | 5.190 | 5.230 | +40 |
| Classes | 249 | 253 | +4 |
| Commits | 747 | 755 | +8 |
| Tamanho | 1.921 GB | 1.921 GB | +122.14 KB |

### Top 3 commits por tamanho de diff

| Rank | Commit | Mensagem | Arquivos | Adições | Reduções | Diff total |
|---:|---|---|---:|---:|---:|---:|
| 1 | `d108f4bcd626` | relatorio | 39 | 5.432 | 78 | 5.510 |
| 2 | `b8e56735481d` | meta dados IA ataques 1 | 4 | 1.883 | 4 | 1.887 |
| 3 | `e4a76d3fd505` | melhorias fortes no sistema do visualizador de logs | 3 | 997 | 754 | 1.751 |

## 10. Gráficos de crescimento

![Crescimento de linhas gerais](../Imagens/2026-05-20_21-53-32/crescimento_linhas_totais.png)

![Crescimento de linhas .py](../Imagens/2026-05-20_21-53-32/crescimento_linhas_py.png)

![Crescimento de arquivos .py](../Imagens/2026-05-20_21-53-32/crescimento_arquivos_py.png)

![Crescimento de commits](../Imagens/2026-05-20_21-53-32/crescimento_commits.png)

![Crescimento de peso do jogo](../Imagens/2026-05-20_21-53-32/crescimento_peso_jogo.png)

![Horas estimadas conforme o tempo](../Imagens/2026-05-20_21-53-32/crescimento_horas_estimadas.png)

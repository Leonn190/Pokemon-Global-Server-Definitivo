...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_6huxwnzt`  
**Gerado em:** 2026-04-29T23:20:50  
...
- **Peso dos arquivos de texto:** 1006.15 KB
- **Tamanho total:** 0.365 GB (391.900.001 bytes)
- **Dias desde a criação do projeto:** 4
- **Dias desde a criação oficial:** 278
- **Horas estimadas:** 69.00
- **Linhas totais gerais:** 11.437
- **Commits (projeto):** 86

## 2. Python

- **Arquivos `.py`:** 99
- **Linhas totais:** 11.436
- **Tamanho total `.py`:** 404.38 KB
- **Classes encontradas:** 55
- **Funções encontradas:** 253
- **Métodos encontrados:** 358
- **Total funções + métodos:** 611
- **Bibliotecas diferentes usadas:** 26

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-03-06_15-56-31/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-03-06_15-56-31/rank_16_pastas_pizza.png)
...
| 4 | `Geradores` | 0 | 13 | 719 | 24.23 |
| 5 | `Cenas` | 0 | 7 | 486 | 16.80 |

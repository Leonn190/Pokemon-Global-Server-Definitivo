...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_8hb97xwx`  
**Gerado em:** 2026-04-29T23:22:52  
...
- **Peso dos arquivos de texto:** 1216.65 KB
- **Tamanho total:** 0.424 GB (454.971.586 bytes)
- **Dias desde a criação do projeto:** 5
- **Dias desde a criação oficial:** 279
- **Horas estimadas:** 76.50
- **Linhas totais gerais:** 14.521
- **Commits (projeto):** 94

## 2. Python

- **Arquivos `.py`:** 96
- **Linhas totais:** 12.075
- **Tamanho total `.py`:** 431.95 KB
- **Classes encontradas:** 59
- **Funções encontradas:** 254
- **Métodos encontrados:** 395
- **Total funções + métodos:** 649
- **Bibliotecas diferentes usadas:** 27

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-03-07_10-39-25/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-03-07_10-39-25/rank_16_pastas_pizza.png)
...
|---:|---:|---:|---:|---:|
| `.py` | 12.075 | 83.16% | 96 | 431.95 KB |
| `.csv` | 1.323 | 9.11% | 2 | 139.23 KB |
| `.java` | 1.109 | 7.64% | 1 | 43.32 KB |
| `.json` | 14 | 0.10% | 2 | 602.15 KB |

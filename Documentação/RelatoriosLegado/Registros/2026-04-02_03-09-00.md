...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_bpm44zxy`  
**Gerado em:** 2026-04-29T23:37:26  
...
- **Peso dos arquivos de texto:** 1390.46 KB
- **Tamanho total:** 0.398 GB (427.777.384 bytes)
- **Dias desde a criação do projeto:** 31
- **Dias desde a criação oficial:** 305
- **Horas estimadas:** 190.00
- **Linhas totais gerais:** 32.923
- **Commits (projeto):** 226

## 2. Python

- **Arquivos `.py`:** 124
- **Linhas totais:** 25.942
- **Tamanho total `.py`:** 1049.97 KB
- **Classes encontradas:** 92
- **Funções encontradas:** 383
- **Métodos encontrados:** 1.081
- **Total funções + métodos:** 1.464
- **Bibliotecas diferentes usadas:** 39

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-04-02_03-09-00/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-04-02_03-09-00/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Telas` | 1 | 15 | 4.368 | 168.14 |
| 2 | `Paineis` | 0 | 13 | 4.022 | 164.42 |
| 3 | `Prefabs` | 0 | 14 | 2.707 | 96.25 |
| 4 | `Outros` | 0 | 4 | 2.679 | 97.35 |
| 5 | `Geradores` | 1 | 16 | 2.534 | 112.76 |
| 6 | `Dados` | 0 | 6 | 1.625 | 157.55 |
...
|---:|---:|---:|---:|---:|
| `.py` | 25.942 | 78.80% | 124 | 1.03 MB |
| `.java` | 2.775 | 8.43% | 1 | 120.61 KB |
| `.json` | 2.673 | 8.12% | 7 | 64.57 KB |
| `.csv` | 1.533 | 4.66% | 5 | 155.31 KB |

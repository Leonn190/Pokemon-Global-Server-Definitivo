...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_kwio15j5`  
**Gerado em:** 2026-04-29T23:46:18  
...
- **Peso dos arquivos de texto:** 1920.97 KB
- **Tamanho total:** 0.404 GB (433.708.018 bytes)
- **Dias desde a criação do projeto:** 39
- **Dias desde a criação oficial:** 313
- **Horas estimadas:** 256.00
- **Linhas totais gerais:** 44.928
- **Commits (projeto):** 309

## 2. Python

- **Arquivos `.py`:** 141
- **Linhas totais:** 36.391
- **Tamanho total `.py`:** 1528.69 KB
- **Classes encontradas:** 130
- **Funções encontradas:** 452
- **Métodos encontrados:** 1.622
- **Total funções + métodos:** 2.074
- **Bibliotecas diferentes usadas:** 42

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-04-10_16-32-53/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-04-10_16-32-53/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Telas` | 1 | 18 | 5.309 | 208.57 |
| 2 | `Dados` | 3 | 34 | 4.687 | 246.08 |
| 3 | `Paineis` | 0 | 14 | 4.621 | 192.92 |
| 4 | `Geradores` | 1 | 16 | 3.757 | 165.98 |
| 5 | `ModulosMundo` | 0 | 12 | 3.651 | 167.51 |
| 6 | `Prefabs` | 0 | 15 | 3.256 | 118.24 |
| 7 | `Outros` | 0 | 5 | 3.193 | 117.36 |
| 8 | `ModulosGerais` | 0 | 11 | 2.474 | 90.99 |
| 9 | `ModulosBatalha` | 0 | 8 | 1.026 | 45.57 |
| 10 | `Cenas` | 0 | 6 | 917 | 39.66 |
| 11 | `ServerLogica` | 0 | 3 | 251 | 12.39 |
...
|---:|---:|---:|---:|---:|
| `.py` | 36.391 | 81.00% | 141 | 1.49 MB |
| `.json` | 3.729 | 8.30% | 28 | 96.89 KB |
| `.java` | 2.835 | 6.31% | 1 | 123.53 KB |
| `.csv` | 1.616 | 3.60% | 7 | 163.79 KB |
| `.toml` | 357 | 0.79% | 10 | 8.07 KB |

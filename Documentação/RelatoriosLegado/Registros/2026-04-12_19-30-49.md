...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_yo7f37am`  
**Gerado em:** 2026-04-29T23:49:47  
...
- **Pastas:** 1.249
- **Arquivos:** 72.044
- **Arquivos de texto:** 215
- **Peso dos arquivos de texto:** 2294.29 KB
- **Tamanho total:** 0.541 GB (581.032.273 bytes)
- **Dias desde a criação do projeto:** 41
- **Dias desde a criação oficial:** 315
- **Horas estimadas:** 286.00
- **Linhas totais gerais:** 53.124
- **Commits (projeto):** 328

## 2. Python

- **Arquivos `.py`:** 163
- **Linhas totais:** 44.080
- **Tamanho total `.py`:** 1879.75 KB
- **Classes encontradas:** 158
- **Funções encontradas:** 526
- **Métodos encontrados:** 1.991
- **Total funções + métodos:** 2.517
- **Bibliotecas diferentes usadas:** 44

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-04-12_19-30-49/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-04-12_19-30-49/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Telas` | 1 | 18 | 5.309 | 208.57 |
| 2 | `Paineis` | 0 | 15 | 5.256 | 221.84 |
| 3 | `Outros` | 0 | 7 | 5.231 | 209.70 |
| 4 | `Dados` | 3 | 37 | 5.188 | 268.27 |
| 5 | `Geradores` | 1 | 16 | 3.855 | 171.79 |
| 6 | `ModulosMundo` | 0 | 12 | 3.651 | 167.51 |
| 7 | `ServerBatalha` | 1 | 16 | 3.405 | 156.49 |
| 8 | `Prefabs` | 0 | 15 | 3.328 | 120.18 |
| 9 | `ModulosGerais` | 0 | 12 | 2.782 | 103.69 |
...
|---:|---:|---:|---:|---:|
| `.py` | 44.080 | 82.99% | 163 | 1.84 MB |
| `.json` | 4.151 | 7.81% | 29 | 113.51 KB |
| `.java` | 2.835 | 5.34% | 1 | 123.53 KB |
| `.csv` | 1.695 | 3.19% | 9 | 169.36 KB |

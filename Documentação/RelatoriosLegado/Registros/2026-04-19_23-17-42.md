...
**Relatório:** #41  
**Projeto:** `relatorio_rebuild_8mq9gitl`  
**Gerado em:** 2026-04-29T23:58:35  
...
- **Peso dos arquivos de texto:** 2735.68 KB
- **Tamanho total:** 0.555 GB (595.588.424 bytes)
- **Dias desde a criação do projeto:** 48
- **Dias desde a criação oficial:** 322
- **Horas estimadas:** 357.00
- **Linhas totais gerais:** 63.415
- **Commits (projeto):** 375
...
- **Arquivos `.py`:** 174
- **Linhas totais:** 52.674
- **Tamanho total `.py`:** 2277.06 KB
- **Classes encontradas:** 173
- **Funções encontradas:** 615
- **Métodos encontrados:** 2.334
- **Total funções + métodos:** 2.949
- **Bibliotecas diferentes usadas:** 44

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-04-19_23-17-42/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-04-19_23-17-42/rank_16_pastas_pizza.png)
...
|---:|---:|---:|---:|---:|
| `.py` | 52.674 | 83.07% | 174 | 2.22 MB |
| `.json` | 4.151 | 6.55% | 29 | 113.51 KB |
| `.java` | 3.843 | 6.06% | 7 | 145.13 KB |
...
|---|---:|---:|---:|
| Arquivos | 72.096 | 72.105 | +9 |
| Linhas | 60.335 | 63.415 | +3.080 |
| Linhas .py | 49.598 | 52.674 | +3.076 |
| Métodos/funções | 2.805 | 2.949 | +144 |
| Classes | 168 | 173 | +5 |
| Commits | 369 | 375 | +6 |
| Tamanho | 566.99 MB | 568.00 MB | +1.01 MB |

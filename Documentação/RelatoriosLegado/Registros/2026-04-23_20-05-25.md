...
**Relatório:** #43  
**Projeto:** `relatorio_rebuild_9n5j7g2o`  
**Gerado em:** 2026-04-30T00:01:10  
...
- **Peso dos arquivos de texto:** 2950.88 KB
- **Tamanho total:** 0.569 GB (610.538.485 bytes)
- **Dias desde a criação do projeto:** 52
- **Dias desde a criação oficial:** 326
- **Horas estimadas:** 366.00
- **Linhas totais gerais:** 69.945
- **Commits (projeto):** 401
- **Adições desde o último relatório:** <span style='color: green'>+77.665</span>
- **Reduções desde o último relatório:** <span style='color: red'>-9.076</span>

## 2. Python

- **Arquivos `.py`:** 174
- **Linhas totais:** 52.917
- **Tamanho total `.py`:** 2286.33 KB
- **Classes encontradas:** 173
- **Funções encontradas:** 625
- **Métodos encontrados:** 2.342
- **Total funções + métodos:** 2.967
- **Bibliotecas diferentes usadas:** 44

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-04-23_20-05-25/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-04-23_20-05-25/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `ServerGerais` | 4 | 48 | 7.779 | 438.00 |
| 2 | `Paineis` | 0 | 16 | 6.008 | 258.83 |
| 3 | `Outros` | 0 | 8 | 5.879 | 233.46 |
| 4 | `Telas` | 1 | 19 | 5.733 | 228.58 |
| 5 | `Dados` | 3 | 37 | 5.201 | 277.80 |
...
|---:|---:|---:|---:|---:|
| `.py` | 52.917 | 75.66% | 174 | 2.23 MB |
| `.md` | 6.281 | 8.98% | 1 | 205.72 KB |
| `.json` | 4.151 | 5.94% | 29 | 113.51 KB |
| `.java` | 3.843 | 5.49% | 7 | 145.13 KB |
| `.csv` | 1.708 | 2.44% | 9 | 178.88 KB |
| `.toml` | 1.039 | 1.49% | 14 | 21.23 KB |
...
|---|---:|---:|---:|
| Arquivos | 72.139 | 72.141 | +2 |
| Linhas | 62.944 | 69.945 | +7.001 |
| Linhas .py | 52.203 | 52.917 | +714 |
| Métodos/funções | 2.920 | 2.967 | +47 |
| Classes | 173 | 173 | 0 |
| Commits | 385 | 401 | +16 |
| Tamanho | 582.03 MB | 582.25 MB | +234.12 KB |

### Top 3 commits por tamanho de diff

| Rank | Commit | Mensagem | Arquivos | Adições | Reduções | Diff total |
|---:|---|---|---:|---:|---:|---:|
| 1 | `a408db9b9329` | atualizaÃ§Ã£o dos relatorios | 785 | 69.452 | 9.098 | 78.550 |
| 2 | `a7a6f525b994` | reformular todo o modelo de batalha mais uma vez (tudo deu errado dnv) | 41 | 4.973 | 6.738 | 11.711 |
| 3 | `acf28fc06268` | SistemaBatalha final antes da implementaÃ§ao de fases | 5 | 382 | 6.172 | 6.554 |

...
- **Peso dos arquivos de texto:** 3843.41 KB
- **Tamanho total:** 0.923 GB (990.686.283 bytes)
- **Dias desde a criação do projeto:** 63
- **Dias desde a criação oficial:** 337
- **Horas estimadas:** 528.50
- **Linhas totais gerais:** 90.858
- **Commits (projeto):** 566
- **Adições desde o último relatório:** <span style='color: green'>+5.722</span>
- **Reduções desde o último relatório:** <span style='color: red'>-855</span>

## 2. Python

- **Arquivos `.py`:** 233
- **Linhas totais:** 65.529
- **Tamanho total `.py`:** 2869.36 KB
- **Classes encontradas:** 212
- **Funções encontradas:** 990
- **Métodos encontrados:** 2.858
- **Total funções + métodos:** 3.848
- **Bibliotecas diferentes usadas:** 47

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-05-04_21-39-29/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-05-04_21-39-29/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Site` | 24 | 1.601 | 10.494 | 256956.32 |
| 2 | `ServerGerais` | 4 | 55 | 9.898 | 551.52 |
| 3 | `Paineis` | 0 | 16 | 8.388 | 377.83 |
| 4 | `Dados` | 7 | 61 | 8.043 | 391.38 |
| 5 | `ServerBatalha` | 1 | 25 | 6.524 | 292.91 |
| 6 | `Telas` | 2 | 20 | 6.154 | 240.87 |
| 7 | `ServerMundo` | 1 | 21 | 5.608 | 297.31 |
| 8 | `Outros` | 0 | 11 | 5.103 | 185.26 |
| 9 | `ModulosGerais` | 1 | 25 | 4.775 | 182.74 |
| 10 | `ModulosMundo` | 0 | 15 | 4.713 | 221.26 |
| 11 | `ModulosBatalha` | 0 | 13 | 4.482 | 214.79 |
| 12 | `ServerLogica` | 4 | 42 | 4.328 | 134.21 |
| 13 | `Geradores` | 1 | 18 | 3.986 | 179.65 |
| 14 | `Prefabs` | 0 | 14 | 3.554 | 130.73 |
| 15 | `Visual` | 0 | 8 | 2.564 | 109.24 |
| 16 | `Cenas` | 0 | 6 | 1.815 | 90.20 |
...
| `Codigo/ModulosMundo/ControladorObjetos.py` | 1.200 | 60.49 |
...
| `Codigo/Cenas/CenaMundo.py` | 894 | 51.64 |
...
| `Codigo/ModulosMundo/ControladorPlayer.py` | 782 | 37.83 |
| `SimuladorServerJogo/Batalha/Partida.py` | 769 | 37.88 |
| `SimuladorServerJogo/Logica/Comandos/Comandos.py` | 729 | 30.92 |
| `SimuladorServerJogo/Gerais/Rotas/Atualizador.py` | 724 | 38.72 |
...
| `Codigo/ModulosBatalha/ControladorBatalha.py` | 672 | 32.38 |
...
| `SimuladorServerJogo/Gerais/Geradores/GeradorDungeons.py` | 593 | 23.83 |
| `Codigo/Visual/ContatoIrregularAnimator.py` | 578 | 23.32 |
| `SimuladorServerJogo/Mundo/Cerebros/CerebroDungeons.py` | 574 | 31.42 |
| `Codigo/Telas/Telas/TelaServers.py` | 570 | 17.90 |
| `SimuladorServerJogo/Gerais/Rotas/Ativador.py` | 562 | 28.00 |
...
| `SimuladorServerJogo/Gerais/LoaderRegras.py` | 494 | 29.58 |
...
| `SimuladorServerJogo/Mundo/Cerebros/CerebroCentral.py` | 479 | 24.56 |
...
| `SimuladorServerJogo/Mundo/Cerebros/CerebroPokemons.py` | `CerebroPokemons.atualizar_movimento` | metodo | 122 |
...
|---:|---:|---:|---:|---:|
| `.py` | 65.529 | 72.21% | 233 | 2.80 MB |
| `.json` | 7.211 | 7.95% | 54 | 178.32 KB |
| `.js` | 4.523 | 4.98% | 23 | 178.39 KB |
| `.java` | 4.254 | 4.69% | 8 | 161.53 KB |
| `.css` | 3.739 | 4.12% | 4 | 86.74 KB |
| `.astro` | 2.217 | 2.44% | 24 | 99.90 KB |
| `.csv` | 1.942 | 2.14% | 10 | 235.76 KB |
| `.toml` | 1.175 | 1.29% | 15 | 24.73 KB |
...
| `.js` | 23 | 178.39 KB | 0.02% |
| `.json` | 54 | 178.32 KB | 0.02% |
| `.java` | 8 | 161.53 KB | 0.02% |
| `.class` | 33 | 135.55 KB | 0.01% |
| `.zip` | 1 | 113.99 KB | 0.01% |
| `.astro` | 24 | 99.90 KB | 0.01% |
| `.css` | 4 | 86.74 KB | 0.01% |
| `.glsl` | 24 | 45.96 KB | 0.00% |
| `.toml` | 15 | 24.73 KB | 0.00% |
...
|---|---:|---:|---:|
| Arquivos | 72.487 | 74.043 | +1.556 |
| Linhas | 88.785 | 90.858 | +2.073 |
| Linhas .py | 63.823 | 65.529 | +1.706 |
| Métodos/funções | 3.771 | 3.848 | +77 |
| Classes | 210 | 212 | +2 |
| Commits | 554 | 566 | +12 |
| Tamanho | 693.87 MB | 944.79 MB | +250.92 MB |

### Top 3 commits por tamanho de diff

| Rank | Commit | Mensagem | Arquivos | Adições | Reduções | Diff total |
|---:|---|---|---:|---:|---:|---:|
| 1 | `148d18721705` | relatorio | 16 | 2.905 | 114 | 3.019 |
| 2 | `84a6d13eecbb` | implementaÃ§Ã£o basica da dungeon | 25 | 1.132 | 96 | 1.228 |
| 3 | `eab65b2b5376` | sistema de dungeons aprimorado | 25 | 900 | 271 | 1.171 |

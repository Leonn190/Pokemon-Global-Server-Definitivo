...
- **Pastas:** 1.298
- **Arquivos:** 74.174
- **Arquivos de texto:** 398
- **Peso dos arquivos de texto:** 4034.71 KB
- **Tamanho total:** 0.893 GB (958.621.940 bytes)
- **Dias desde a criação do projeto:** 65
- **Dias desde a criação oficial:** 339
- **Horas estimadas:** 553.50
- **Linhas totais gerais:** 94.427
- **Commits (projeto):** 584
- **Adições desde o último relatório:** <span style='color: green'>+6.176</span>
- **Reduções desde o último relatório:** <span style='color: red'>-655</span>

## 2. Python

- **Arquivos `.py`:** 241
- **Linhas totais:** 68.713
- **Tamanho total `.py`:** 3033.82 KB
- **Classes encontradas:** 221
- **Funções encontradas:** 1.029
- **Métodos encontrados:** 2.969
- **Total funções + métodos:** 3.998
- **Bibliotecas diferentes usadas:** 48

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-05-06_23-42-01/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-05-06_23-42-01/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Site` | 23 | 1.625 | 10.803 | 30747.25 |
| 2 | `ServerGerais` | 4 | 55 | 10.457 | 582.46 |
| 3 | `Paineis` | 0 | 16 | 8.388 | 377.83 |
| 4 | `Dados` | 6 | 61 | 8.100 | 402.73 |
| 5 | `ServerBatalha` | 1 | 25 | 7.030 | 319.06 |
| 6 | `ServerMundo` | 2 | 25 | 6.496 | 346.85 |
| 7 | `Telas` | 2 | 20 | 6.163 | 241.68 |
| 8 | `Outros` | 0 | 12 | 5.359 | 193.25 |
| 9 | `ModulosMundo` | 0 | 16 | 5.005 | 235.88 |
| 10 | `ModulosGerais` | 1 | 25 | 4.787 | 183.40 |
| 11 | `ModulosBatalha` | 0 | 13 | 4.511 | 217.57 |
| 12 | `ServerLogica` | 4 | 42 | 4.438 | 138.01 |
| 13 | `Geradores` | 1 | 19 | 4.316 | 196.47 |
| 14 | `Prefabs` | 0 | 14 | 3.580 | 131.89 |
| 15 | `Visual` | 0 | 9 | 2.682 | 115.04 |
...
| `SimuladorServerJogo/Gerais/EstadoServidor.py` | 1.306 | 56.06 |
...
| `SimuladorServerJogo/Batalha/PokemonBatalha.py` | 1.014 | 53.87 |
| `SimuladorServerJogo/Batalha/Partida.py` | 969 | 48.64 |
| `Codigo/Cenas/CenaMundo.py` | 962 | 55.62 |
| `SimuladorServerJogo/Gerais/Geradores/GeradorPokemon.py` | 922 | 38.32 |
| `Codigo/ModulosMundo/ControladorPlayer.py` | 917 | 44.99 |
| `SimuladorServerJogo/Mundo/Cerebros/CerebroDungeons.py` | 915 | 53.10 |
| `SimuladorServerJogo/Gerais/Geradores/GeradorDungeons.py` | 881 | 40.18 |
| `Codigo/Prefabs/Texto.py` | 819 | 31.41 |
| `Codigo/ModulosBatalha/MontadorJogadas.py` | 810 | 41.50 |
| `SimuladorServerJogo/Mundo/BancoDados.py` | 803 | 40.04 |
| `SimuladorServerJogo/Gerais/Rotas/Atualizador.py` | 733 | 40.02 |
...
| `Codigo/Geradores/Ator.py` | 468 | 21.78 |
...
| `SimuladorServerJogo/Batalha/PokemonBatalha.py` | `PokemonBatalha.ReceberEfeito` | metodo | 130 |
...
|---:|---:|---:|---:|---:|
| `.py` | 68.713 | 72.85% | 241 | 2.96 MB |
| `.json` | 7.225 | 7.66% | 54 | 178.61 KB |
| `.js` | 4.639 | 4.92% | 23 | 185.49 KB |
| `.java` | 4.254 | 4.51% | 8 | 161.53 KB |
| `.css` | 3.863 | 4.10% | 14 | 91.12 KB |
| `.astro` | 2.286 | 2.42% | 30 | 103.35 KB |
| `.csv` | 1.985 | 2.10% | 10 | 246.83 KB |
| `.toml` | 1.194 | 1.27% | 15 | 25.29 KB |
...
| `.astro` | 30 | 103.35 KB | 0.01% |
| `.css` | 14 | 91.12 KB | 0.01% |
| `.glsl` | 25 | 46.73 KB | 0.01% |
...
|---|---:|---:|---:|
| Arquivos | 74.078 | 74.174 | +96 |
| Linhas | 93.339 | 94.427 | +1.088 |
| Linhas .py | 67.626 | 68.713 | +1.087 |
| Métodos/funções | 3.950 | 3.998 | +48 |
| Classes | 221 | 221 | 0 |
| Commits | 574 | 584 | +10 |
| Tamanho | 965.48 MB | 914.21 MB | -51.27 MB |

### Top 3 commits por tamanho de diff

| Rank | Commit | Mensagem | Arquivos | Adições | Reduções | Diff total |
|---:|---|---|---:|---:|---:|---:|
| 1 | `89b62442a928` | relatorio | 16 | 4.669 | 236 | 4.905 |
| 2 | `55ef4cbda10c` | ajustes firmes na batalha | 11 | 709 | 91 | 800 |
| 3 | `04dcc85bd70d` | mais ajustes nas dungeons (inferno) | 14 | 341 | 204 | 545 |

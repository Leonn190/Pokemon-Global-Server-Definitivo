...
- **Peso dos arquivos de texto:** 4186.17 KB
- **Tamanho total:** 1.075 GB (1.154.050.155 bytes)
- **Dias desde a criação do projeto:** 68
- **Dias desde a criação oficial:** 342
- **Horas estimadas:** 568.00
- **Linhas totais gerais:** 97.749
- **Commits (projeto):** 609
- **Adições desde o último relatório:** <span style='color: green'>+4.740</span>
- **Reduções desde o último relatório:** <span style='color: red'>-151</span>

## 2. Python

- **Arquivos `.py`:** 240
- **Linhas totais:** 71.386
- **Tamanho total `.py`:** 3167.93 KB
- **Classes encontradas:** 222
- **Funções encontradas:** 1.060
- **Métodos encontrados:** 3.074
- **Total funções + métodos:** 4.134
- **Bibliotecas diferentes usadas:** 47

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-05-09_01-44-52/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-05-09_01-44-52/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Site` | 24 | 1.637 | 11.286 | 30757.49 |
| 2 | `ServerGerais` | 4 | 55 | 10.544 | 585.83 |
| 3 | `Paineis` | 0 | 16 | 8.388 | 376.11 |
| 4 | `Dados` | 6 | 61 | 8.266 | 409.71 |
| 5 | `ServerBatalha` | 1 | 26 | 7.736 | 351.56 |
| 6 | `ServerMundo` | 2 | 25 | 6.631 | 354.28 |
| 7 | `Telas` | 2 | 20 | 6.163 | 245.11 |
| 8 | `Outros` | 0 | 10 | 6.106 | 228.73 |
| 9 | `ModulosBatalha` | 0 | 13 | 5.373 | 260.54 |
| 10 | `ModulosMundo` | 0 | 16 | 5.014 | 236.96 |
| 11 | `ModulosGerais` | 1 | 25 | 4.846 | 185.66 |
| 12 | `ServerLogica` | 4 | 42 | 4.427 | 138.13 |
| 13 | `Geradores` | 1 | 19 | 4.345 | 197.86 |
| 14 | `Prefabs` | 0 | 14 | 3.580 | 131.89 |
| 15 | `Visual` | 0 | 9 | 2.732 | 120.24 |
| 16 | `Cenas` | 0 | 6 | 1.883 | 94.21 |
...
| `Codigo/ModulosMundo/ControladorPlayer.py` | 923 | 45.50 |
...
| `SimuladorServerJogo/Gerais/Geradores/GeradorDungeons.py` | 885 | 40.55 |
...
|---:|---:|---:|---:|---:|
| `.py` | 71.386 | 73.11% | 240 | 3.09 MB |
| `.json` | 7.391 | 7.57% | 54 | 186.03 KB |
| `.js` | 4.692 | 4.81% | 23 | 188.79 KB |
| `.css` | 4.342 | 4.45% | 14 | 107.28 KB |
| `.java` | 4.254 | 4.36% | 8 | 161.23 KB |
| `.astro` | 2.237 | 2.29% | 42 | 94.09 KB |
| `.csv` | 1.985 | 2.03% | 10 | 246.83 KB |
| `.toml` | 1.194 | 1.22% | 15 | 25.27 KB |
...
|---|---:|---:|---:|
| Arquivos | 74.264 | 74.280 | +16 |
| Linhas | 97.611 | 97.749 | +138 |
| Linhas .py | 71.248 | 71.386 | +138 |
| Métodos/funções | 4.130 | 4.134 | +4 |
| Classes | 222 | 222 | 0 |
| Commits | 605 | 609 | +4 |
| Tamanho | 1.046 GB | 1.075 GB | +29.13 MB |

### Top 3 commits por tamanho de diff

| Rank | Commit | Mensagem | Arquivos | Adições | Reduções | Diff total |
|---:|---|---|---:|---:|---:|---:|
| 1 | `fdbc3da4cb7e` | relatorio | 16 | 4.585 | 134 | 4.719 |
| 2 | `820ce330f075` | armadilha espeto ricochet | 3 | 108 | 4 | 112 |
| 3 | `86ed9880b600` | bug da armadilha torreta e do drop em dimensÃµes | 8 | 47 | 13 | 60 |

...
- **Pastas:** 1.279
- **Arquivos:** 73.985
- **Arquivos de texto:** 416
- **Peso dos arquivos de texto:** 4403.43 KB
- **Tamanho total:** 1.463 GB (1.571.394.156 bytes)
- **Dias desde a criação do projeto:** 69
- **Dias desde a criação oficial:** 343
- **Horas estimadas:** 593.00
- **Linhas totais gerais:** 104.958
- **Commits (projeto):** 636
- **Adições desde o último relatório:** <span style='color: green'>+6.222</span>
- **Reduções desde o último relatório:** <span style='color: red'>-412</span>

## 2. Python

- **Arquivos `.py`:** 242
- **Linhas totais:** 72.616
- **Tamanho total `.py`:** 3222.49 KB
- **Classes encontradas:** 224
- **Funções encontradas:** 1.097
- **Métodos encontrados:** 3.115
- **Total funções + métodos:** 4.212
- **Bibliotecas diferentes usadas:** 47

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-05-10_23-11-23/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-05-10_23-11-23/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Dados` | 6 | 61 | 13.374 | 549.03 |
| 2 | `Site` | 24 | 1.867 | 12.118 | 41990.19 |
| 3 | `ServerGerais` | 4 | 57 | 10.895 | 610.39 |
| 4 | `Paineis` | 0 | 17 | 8.477 | 379.61 |
| 5 | `ServerBatalha` | 1 | 26 | 7.736 | 351.56 |
| 6 | `ServerMundo` | 2 | 26 | 7.115 | 374.99 |
| 7 | `Telas` | 2 | 20 | 6.169 | 245.54 |
| 8 | `Outros` | 0 | 10 | 6.144 | 230.22 |
| 9 | `ModulosBatalha` | 0 | 13 | 5.455 | 263.59 |
| 10 | `ModulosMundo` | 0 | 16 | 5.098 | 241.18 |
| 11 | `ModulosGerais` | 1 | 25 | 4.830 | 185.01 |
| 12 | `ServerLogica` | 4 | 42 | 4.573 | 143.07 |
| 13 | `Geradores` | 1 | 19 | 4.346 | 197.92 |
| 14 | `Prefabs` | 0 | 14 | 3.580 | 131.89 |
| 15 | `Visual` | 0 | 9 | 2.732 | 120.24 |
| 16 | `Cenas` | 0 | 6 | 1.887 | 94.76 |
...
| `Codigo/ModulosMundo/ControladorObjetos.py` | 1.310 | 66.55 |
...
| `Codigo/Cenas/CenaMundo.py` | 966 | 56.29 |
...
| `Codigo/Geradores/PokemonMundo.py` | 688 | 33.24 |
...
| `SimuladorServerJogo/Mundo/InicializadorNPC.py` | 538 | 27.53 |
| `Codigo/Visual/ContatoIrregularAnimator.py` | 529 | 24.09 |
| `Outros/GameTestFPS.py` | 528 | 17.62 |
| `SimuladorServerJogo/Gerais/LoaderRegras.py` | 528 | 31.91 |
...
| `SimuladorServerJogo/Mundo/Cerebros/CerebroCentral.py` | 492 | 25.62 |
...
| `Codigo/Cenas/CenaMundo.py` | `CenaMundo` | 925 |
...
|---|---:|---:|---:|
| `Codigo/Cenas/CenaMundo.py` | 24 | 27 | 966 |
...
![Gráfico de barras das linhas por extensão](../Imagens/2026-05-10_23-11-23/linhas_por_extensao_barras.png)

![Gráfico de pizza das linhas por extensão](../Imagens/2026-05-10_23-11-23/linhas_por_extensao_pizza.png)

| Ext | Linhas | % das linhas | Arquivos | Peso |
|---:|---:|---:|---:|---:|
| `.py` | 72.616 | 69.26% | 242 | 3.15 MB |
| `.json` | 12.404 | 11.83% | 54 | 293.40 KB |
| `.js` | 5.079 | 4.84% | 25 | 199.45 KB |
| `.css` | 4.622 | 4.41% | 15 | 112.69 KB |
| `.java` | 4.254 | 4.06% | 8 | 161.50 KB |
| `.astro` | 2.402 | 2.29% | 44 | 100.53 KB |
| `.csv` | 2.080 | 1.98% | 10 | 278.77 KB |
| `.toml` | 1.233 | 1.18% | 15 | 25.88 KB |
| `.md` | 157 | 0.15% | 1 | 7.07 KB |

## 7. Peso por extensão

![Gráfico de barras do peso por extensão - Top 12](../Imagens/2026-05-10_23-11-23/peso_por_extensao_barras_top12.png)

![Gráfico de pizza do peso por categoria](../Imagens/2026-05-10_23-11-23/peso_por_categoria_pizza.png)

| Ext | Arquivos | Peso | % do jogo |
|---:|---:|---:|---:|
| `.png` | 72.440 | 1.146 GB | 78.33% |
| `.mp3` | 25 | 181.46 MB | 12.11% |
| `.ogg` | 36 | 92.81 MB | 6.19% |
| `.webp` | 967 | 36.48 MB | 2.43% |
| `.wav` | 9 | 3.81 MB | 0.25% |
| `.jpg` | 23 | 3.61 MB | 0.24% |
| `.py` | 242 | 3.15 MB | 0.21% |
| `.zip` | 1 | 1.79 MB | 0.12% |
...
| `.csv` | 10 | 278.77 KB | 0.02% |
| `.js` | 25 | 199.45 KB | 0.01% |
| `.java` | 8 | 161.50 KB | 0.01% |
| `.class` | 35 | 142.32 KB | 0.01% |
| `.css` | 15 | 112.69 KB | 0.01% |
| `.astro` | 44 | 100.53 KB | 0.01% |
| `.glsl` | 25 | 45.85 KB | 0.00% |
| `.toml` | 15 | 25.88 KB | 0.00% |
...
|---|---:|---:|---:|
| Arquivos | 74.382 | 73.985 | -397 |
| Linhas | 103.612 | 104.958 | +1.346 |
| Linhas .py | 72.255 | 72.616 | +361 |
| Métodos/funções | 4.193 | 4.212 | +19 |
| Classes | 223 | 224 | +1 |
| Commits | 626 | 636 | +10 |
| Tamanho | 1.277 GB | 1.463 GB | +191.11 MB |

### Top 3 commits por tamanho de diff

| Rank | Commit | Mensagem | Arquivos | Adições | Reduções | Diff total |
|---:|---|---|---:|---:|---:|---:|
| 1 | `54562763d668` | relatorio | 16 | 4.577 | 113 | 4.690 |
| 2 | `80defcdf887f` | pro tras do jogo no site | 27 | 806 | 59 | 865 |
| 3 | `8d526be16385` | sistema de captura com frutas e pokebola melhorado e corrigido | 13 | 390 | 59 | 449 |

## 9. Gráficos de crescimento

![Crescimento de linhas gerais](../Imagens/2026-05-10_23-11-23/crescimento_linhas_totais.png)

![Crescimento de linhas .py](../Imagens/2026-05-10_23-11-23/crescimento_linhas_py.png)

![Crescimento de arquivos .py](../Imagens/2026-05-10_23-11-23/crescimento_arquivos_py.png)

![Crescimento de commits](../Imagens/2026-05-10_23-11-23/crescimento_commits.png)

![Crescimento de peso do jogo](../Imagens/2026-05-10_23-11-23/crescimento_peso_jogo.png)

...
Coloque este arquivo em Ferramentas/EditorAnimaçãoAtaques.py e rode pela raiz:

    python Ferramentas/EditorAnimaçãoAtaques.py
...
try:
    ...
    raise SystemExit(
        "EditorAnimaçãoAtaques depende do arquivo Ferramentas/SimuladorBatalha.py.\n"
        "Coloque este arquivo na mesma pasta Ferramentas do simulador real e rode novamente.\n"

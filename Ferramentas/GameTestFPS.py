# GameTestFPS.py
# Coloque este arquivo em Ferramentas/GameTestFPS.py e rode pela raiz do repo:
# python Ferramentas/GameTestFPS.py
...
# Garante que imports como Codigo.* e Ferramentas.* funcionem mesmo com o arquivo dentro de Ferramentas.

...
**Relatório:** #5  
**Repo:** `relatorio_rebuild_t0yusur6`  
**Gerado em:** 2026-04-13T22:38:43-03:00  
...
- **Peso dos arquivos de texto:** 180.56 KB
- **Tamanho total:** 0.328 GB (352.555.231 bytes)
- **Dias desde a criação do repo:** 2
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 5.509
- **Commits (repo):** 40
...
- **Arquivos `.py`:** 79
- **Linhas totais:** 5.509
- **Tamanho total `.py`:** 180.56 KB
- **Classes encontradas:** 18
- **Funções encontradas:** 157
- **Métodos encontrados:** 110
- **Total funções + métodos:** 267
...
|---:|---|---|---:|---:|---:|---:|
| 1 | `Telas` | `Codigo/Telas` | 1 | 14 | 2.056 | 66.04 |
| 2 | `Outros` | `Outros` | 0 | 3 | 1.432 | 48.80 |
| 3 | `Prefabs` | `Codigo/Prefabs` | 0 | 10 | 1.061 | 36.90 |
| 4 | `Cenas` | `Codigo/Cenas` | 0 | 7 | 211 | 6.06 |
| 5 | `Server` | `Codigo/Server` | 0 | 3 | 95 | 2.61 |

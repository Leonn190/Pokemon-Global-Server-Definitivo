...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_x74mb7tg`  
**Gerado em:** 2026-04-23T19:01:28  
...
- **Peso dos arquivos de texto:** 741.32 KB
- **Tamanho total:** 0.368 GB (394.663.114 bytes)
- **Dias desde a criação do repo:** 7
- **Dias desde a criação oficial:** 281
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 17.770
- **Commits (repo):** 129

## Python

- **Arquivos `.py`:** 106
- **Linhas totais:** 14.808
- **Tamanho total `.py`:** 537.04 KB
- **Classes encontradas:** 64
- **Funções encontradas:** 266
- **Métodos encontrados:** 501
- **Total funções + métodos:** 767

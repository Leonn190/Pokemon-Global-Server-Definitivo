...
**Relatório:** #14  
**Repo:** `relatorio_rebuild_d1wdef7j`  
**Gerado em:** 2026-04-13T22:48:02-03:00  
...
- **Pastas:** 1.151
- **Arquivos:** 68.181
- **Arquivos de texto:** 116
- **Peso dos arquivos de texto:** 727.67 KB
- **Tamanho total:** 0.368 GB (394.649.145 bytes)
- **Dias desde a criação do repo:** 7
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 17.441
- **Commits (repo):** 129

## Python

- **Arquivos `.py`:** 106
- **Linhas totais:** 14.479
- **Tamanho total `.py`:** 523.40 KB
- **Classes encontradas:** 64
- **Funções encontradas:** 253
- **Métodos encontrados:** 501
- **Total funções + métodos:** 754
- **Bibliotecas diferentes usadas:** 26

## Rank das 15 pastas mais relevantes por linhas

![Gráfico de barras do rank das 15 pastas](Imagens/2026-03-09_22-08-33/rank_15_pastas_barras.png)

![Gráfico de pizza do rank das 15 pastas](Imagens/2026-03-09_22-08-33/rank_15_pastas_pizza.png)

| Rank | Pasta | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `Telas` | `Codigo/Telas` | 1 | 14 | 2.872 | 98.89 |
| 2 | `Outros` | `Outros` | 0 | 3 | 1.736 | 59.27 |
| 3 | `Geradores` | `Codigo/Geradores` | 2 | 23 | 1.709 | 61.03 |
| 4 | `Prefabs` | `Codigo/Prefabs` | 0 | 11 | 1.591 | 55.49 |
| 5 | `Dados` | `Dados` | 0 | 3 | 1.364 | 140.29 |
| 6 | `Cenas` | `Codigo/Cenas` | 0 | 7 | 564 | 20.44 |
| 7 | `Paineis` | `Codigo/Paineis` | 0 | 6 | 292 | 9.30 |
| 8 | `Server` | `Codigo/Server` | 0 | 4 | 241 | 7.57 |
| 9 | `ModulosBatalha` | `Codigo/ModulosBatalha` | 0 | 0 | 0 | 0.00 |
| 10 | `ModulosGerais` | `Codigo/ModulosGerais` | 0 | 0 | 0 | 0.00 |
| 11 | `ModulosMundo` | `Codigo/ModulosMundo` | 0 | 0 | 0 | 0.00 |
...
| `SimuladorServerJogo/Rotas/Ativador.py` | `processar_ativador_json` | funcao | 71 |

...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_eyhuvdp6`  
**Gerado em:** 2026-04-23T19:05:37  
...
- **Peso dos arquivos de texto:** 960.35 KB
- **Tamanho total:** 0.378 GB (405.757.636 bytes)
- **Dias desde a criação do repo:** 10
- **Dias desde a criação oficial:** 284
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 22.183
- **Commits (repo):** 160

## Python

- **Arquivos `.py`:** 119
- **Linhas totais:** 17.407
- **Tamanho total `.py`:** 686.49 KB
- **Classes encontradas:** 74
- **Funções encontradas:** 296
- **Métodos encontrados:** 639
- **Total funções + métodos:** 935
...
|---:|---:|---:|---:|
| `.png` | 68.038 | 338.81 MB | 87.56% |
| `.ogg` | 17 | 46.32 MB | 11.97% |
| `.py` | 119 | 686.49 KB | 0.17% |

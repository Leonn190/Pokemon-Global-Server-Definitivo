...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_7cv3h_5n`  
**Gerado em:** 2026-04-23T19:10:44  
...
- **Peso dos arquivos de texto:** 1136.32 KB
- **Tamanho total:** 0.380 GB (407.887.452 bytes)
- **Dias desde a criação do repo:** 20
- **Dias desde a criação oficial:** 294
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 27.250
- **Commits (repo):** 186

## Python

- **Arquivos `.py`:** 117
- **Linhas totais:** 20.421
- **Tamanho total `.py`:** 808.35 KB
- **Classes encontradas:** 83
- **Funções encontradas:** 313
- **Métodos encontrados:** 811
- **Total funções + métodos:** 1.124
...
|---:|---:|---:|---:|
| `.png` | 68.077 | 340.64 MB | 87.57% |
| `.ogg` | 17 | 46.32 MB | 11.91% |
| `.py` | 117 | 808.35 KB | 0.20% |

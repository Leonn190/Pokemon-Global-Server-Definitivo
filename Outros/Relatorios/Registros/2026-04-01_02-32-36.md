...
**Relatório:** #22  
**Repo:** `relatorio_rebuild_slnq1c64`  
**Gerado em:** 2026-04-13T22:58:20-03:00  
...
- **Peso dos arquivos de texto:** 1296.28 KB
- **Tamanho total:** 0.396 GB (425.027.197 bytes)
- **Dias desde a criação do repo:** 30
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 30.775
- **Commits (repo):** 214

## Python

- **Arquivos `.py`:** 121
- **Linhas totais:** 23.923
- **Tamanho total `.py`:** 964.26 KB
- **Classes encontradas:** 91
- **Funções encontradas:** 310
- **Métodos encontrados:** 1.027
- **Total funções + métodos:** 1.337
...
|---:|---|---|---:|---:|---:|---:|
| 1 | `Telas` | `Codigo/Telas` | 1 | 15 | 3.995 | 149.81 |
| 2 | `Paineis` | `Codigo/Paineis` | 0 | 12 | 3.688 | 149.74 |
| 3 | `Prefabs` | `Codigo/Prefabs` | 0 | 14 | 2.655 | 94.26 |
| 4 | `Geradores` | `Codigo/Geradores` | 1 | 16 | 2.447 | 109.07 |
| 5 | `Outros` | `Outros` | 0 | 3 | 1.751 | 59.71 |
| 6 | `Dados` | `Dados` | 0 | 5 | 1.496 | 149.08 |

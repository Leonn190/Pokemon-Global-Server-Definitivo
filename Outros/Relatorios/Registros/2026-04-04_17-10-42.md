...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_1n9x7lw1`  
**Gerado em:** 2026-04-23T19:18:29  
...
- **Peso dos arquivos de texto:** 1594.20 KB
- **Tamanho total:** 0.405 GB (434.787.320 bytes)
- **Dias desde a criação do repo:** 33
- **Dias desde a criação oficial:** 307
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 37.689
- **Commits (repo):** 266

## Python

- **Arquivos `.py`:** 130
- **Linhas totais:** 29.182
- **Tamanho total `.py`:** 1210.76 KB
- **Classes encontradas:** 106
- **Funções encontradas:** 362
- **Métodos encontrados:** 1.242
- **Total funções + métodos:** 1.604

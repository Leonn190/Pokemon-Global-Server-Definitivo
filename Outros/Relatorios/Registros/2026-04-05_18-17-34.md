...
**Relatório:** #27  
**Repo:** `relatorio_rebuild_bb_giuiu`  
**Gerado em:** 2026-04-13T23:04:13-03:00  
...
- **Peso dos arquivos de texto:** 1629.98 KB
- **Tamanho total:** 0.405 GB (434.823.957 bytes)
- **Dias desde a criação do repo:** 34
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 38.773
- **Commits (repo):** 274

## Python

- **Arquivos `.py`:** 130
- **Linhas totais:** 29.106
- **Tamanho total `.py`:** 1211.12 KB
- **Classes encontradas:** 106
- **Funções encontradas:** 351
...
|---:|---|---|---:|---:|---:|---:|
| 1 | `Telas` | `Codigo/Telas` | 1 | 16 | 5.079 | 200.71 |
| 2 | `Paineis` | `Codigo/Paineis` | 0 | 13 | 4.308 | 176.82 |
| 3 | `Dados` | `Dados` | 3 | 31 | 3.714 | 219.17 |
| 4 | `Geradores` | `Codigo/Geradores` | 1 | 17 | 3.067 | 138.86 |
| 5 | `Prefabs` | `Codigo/Prefabs` | 0 | 14 | 3.060 | 110.19 |
| 6 | `Outros` | `Outros` | 0 | 3 | 1.751 | 59.71 |
| 7 | `Cenas` | `Codigo/Cenas` | 0 | 7 | 741 | 30.63 |

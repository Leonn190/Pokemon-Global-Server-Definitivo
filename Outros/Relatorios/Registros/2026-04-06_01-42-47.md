...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_jrqzdic0`  
**Gerado em:** 2026-04-23T19:21:08  
...
- **Peso dos arquivos de texto:** 1736.08 KB
- **Tamanho total:** 0.405 GB (434.940.158 bytes)
- **Dias desde a criação do repo:** 35
- **Dias desde a criação oficial:** 309
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 41.315
- **Commits (repo):** 285

## Python

- **Arquivos `.py`:** 134
- **Linhas totais:** 31.451
- **Tamanho total `.py`:** 1307.94 KB
- **Classes encontradas:** 114
- **Funções encontradas:** 380
- **Métodos encontrados:** 1.348
- **Total funções + métodos:** 1.728

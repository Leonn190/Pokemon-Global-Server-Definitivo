...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_kprepg_6`  
**Gerado em:** 2026-04-23T19:22:22  
...
- **Peso dos arquivos de texto:** 1803.79 KB
- **Tamanho total:** 0.405 GB (434.888.576 bytes)
- **Dias desde a criação do repo:** 37
- **Dias desde a criação oficial:** 311
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 42.136
- **Commits (repo):** 295

## Python

- **Arquivos `.py`:** 140
- **Linhas totais:** 34.394
- **Tamanho total `.py`:** 1429.79 KB
- **Classes encontradas:** 120
- **Funções encontradas:** 445
- **Métodos encontrados:** 1.480
- **Total funções + métodos:** 1.925
...
| 6 | `Outros` | 0 | 4 | 2.594 | 93.36 |
| 7 | `Cenas` | 0 | 7 | 870 | 36.56 |
| 8 | `Server` | 0 | 4 | 358 | 12.95 |
| 9 | `ServerLogica` | 0 | 3 | 251 | 12.39 |

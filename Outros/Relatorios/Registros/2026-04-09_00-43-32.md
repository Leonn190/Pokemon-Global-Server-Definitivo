...
**Relatório:** #1  
**Projeto:** `relatorio_rebuild_jrgyiaur`  
**Gerado em:** 2026-04-29T23:45:11  
...
- **Pastas:** 1.181
- **Arquivos:** 69.034
- **Arquivos de texto:** 185
- **Peso dos arquivos de texto:** 1860.21 KB
- **Tamanho total:** 0.404 GB (433.642.135 bytes)
- **Dias desde a criação do projeto:** 38
- **Dias desde a criação oficial:** 312
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 43.597
- **Commits (projeto):** 305

## 2. Python

- **Arquivos `.py`:** 137
- **Linhas totais:** 35.064
- **Tamanho total `.py`:** 1468.24 KB
- **Classes encontradas:** 124
- **Funções encontradas:** 448
- **Métodos encontrados:** 1.548
- **Total funções + métodos:** 1.996
- **Bibliotecas diferentes usadas:** 42

## 3. Principais pastas

![Gráfico de barras das 16 pastas principais](../Imagens/2026-04-09_00-43-32/rank_16_pastas_barras.png)

![Gráfico de pizza das 16 pastas principais](../Imagens/2026-04-09_00-43-32/rank_16_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `Telas` | 1 | 18 | 5.310 | 208.65 |
| 2 | `Dados` | 3 | 34 | 4.687 | 245.84 |
| 3 | `Paineis` | 0 | 13 | 4.343 | 178.73 |
| 4 | `ModulosMundo` | 0 | 12 | 3.638 | 166.89 |
| 5 | `Geradores` | 1 | 16 | 3.451 | 153.15 |
| 6 | `Prefabs` | 0 | 15 | 3.200 | 115.27 |
| 7 | `Outros` | 0 | 5 | 3.193 | 117.36 |
| 8 | `ModulosGerais` | 0 | 11 | 2.379 | 87.99 |
| 9 | `Cenas` | 0 | 6 | 908 | 38.80 |
| 10 | `ModulosBatalha` | 0 | 5 | 464 | 20.48 |
...
|---:|---:|---:|---:|---:|
| `.py` | 35.064 | 80.43% | 137 | 1.43 MB |
| `.json` | 3.729 | 8.55% | 28 | 96.89 KB |
| `.java` | 2.835 | 6.50% | 1 | 123.53 KB |
| `.csv` | 1.616 | 3.71% | 7 | 163.55 KB |
| `.toml` | 353 | 0.81% | 10 | 8.00 KB |

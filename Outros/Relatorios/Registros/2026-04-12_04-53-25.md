...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_g1ui8op7`  
**Gerado em:** 2026-04-23T19:27:43  
...
- **Peso dos arquivos de texto:** 2217.94 KB
- **Tamanho total:** 0.445 GB (477.382.538 bytes)
- **Dias desde a criação do repo:** 41
- **Dias desde a criação oficial:** 315
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 51.176
- **Commits (repo):** 323

## Python

- **Arquivos `.py`:** 159
- **Linhas totais:** 42.515
- **Tamanho total `.py`:** 1819.73 KB
- **Classes encontradas:** 155
- **Funções encontradas:** 450
- **Métodos encontrados:** 1.963
- **Total funções + métodos:** 2.413
...
| 3 | `Dados` | 3 | 36 | 4.805 | 251.94 |
| 4 | `Outros` | 0 | 5 | 4.445 | 178.35 |

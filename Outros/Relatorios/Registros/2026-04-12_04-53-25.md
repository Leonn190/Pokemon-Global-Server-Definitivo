...
**Relatório:** #33  
**Repo:** `relatorio_rebuild_dg01q3xa`  
**Gerado em:** 2026-04-13T23:11:33-03:00  
...
- **Pastas:** 1.186
- **Arquivos:** 69.083
- **Arquivos de texto:** 210
- **Peso dos arquivos de texto:** 2204.30 KB
- **Tamanho total:** 0.445 GB (477.368.569 bytes)
- **Dias desde a criação do repo:** 41
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 50.847
- **Commits (repo):** 323

## Python

- **Arquivos `.py`:** 159
- **Linhas totais:** 42.186
- **Tamanho total `.py`:** 1806.09 KB
- **Classes encontradas:** 155
- **Funções encontradas:** 437
- **Métodos encontrados:** 1.963
- **Total funções + métodos:** 2.400
- **Bibliotecas diferentes usadas:** 42

## Rank das 15 pastas mais relevantes por linhas

![Gráfico de barras do rank das 15 pastas](Imagens/2026-04-12_04-53-25/rank_15_pastas_barras.png)

![Gráfico de pizza do rank das 15 pastas](Imagens/2026-04-12_04-53-25/rank_15_pastas_pizza.png)
...
| 3 | `Dados` | `Dados` | 3 | 36 | 4.805 | 251.94 |
| 4 | `Outros` | `Outros` | 0 | 5 | 4.116 | 164.71 |
...
| 8 | `SimuladorServerJogo/Batalha` | `SimuladorServerJogo/Batalha` | 1 | 15 | 2.944 | 140.83 |
| 9 | `ModulosGerais` | `Codigo/ModulosGerais` | 0 | 11 | 2.474 | 91.06 |

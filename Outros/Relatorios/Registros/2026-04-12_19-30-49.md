...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_spnk501o`  
**Gerado em:** 2026-04-23T19:29:09  
...
- **Peso dos arquivos de texto:** 2270.29 KB
- **Tamanho total:** 0.541 GB (581.007.695 bytes)
- **Dias desde a criação do repo:** 41
- **Dias desde a criação oficial:** 315
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 52.525
- **Commits (repo):** 328

## Python

- **Arquivos `.py`:** 162
- **Linhas totais:** 43.481
- **Tamanho total `.py`:** 1855.75 KB
- **Classes encontradas:** 158
- **Funções encontradas:** 489
- **Métodos encontrados:** 1.991
- **Total funções + métodos:** 2.480
...
| 3 | `Dados` | 3 | 37 | 5.188 | 268.27 |
| 4 | `Outros` | 0 | 6 | 4.632 | 185.70 |
...
| 12 | `Server` | 0 | 5 | 405 | 14.69 |
| 13 | `ServerLogica` | 0 | 3 | 251 | 12.39 |

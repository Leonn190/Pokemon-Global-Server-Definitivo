...
**Gerado em:** 2026-04-14T21:10:56-03:00  
...
- **Pastas:** 1.252
- **Arquivos:** 72.077
- **Arquivos de texto:** 219
- **Peso dos arquivos de texto:** 2387.67 KB
- **Tamanho total:** 0.549 GB (589.730.773 bytes)
- **Dias desde a criação do repo:** 43
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 55.805
- **Commits (repo):** 348

## Python

- **Arquivos `.py`:** 162
- **Linhas totais:** 46.574
- **Tamanho total `.py`:** 1997.43 KB
- **Classes encontradas:** 160
- **Funções encontradas:** 513
- **Métodos encontrados:** 2.122
- **Total funções + métodos:** 2.635
- **Bibliotecas diferentes usadas:** 43

## Rank das 15 pastas mais relevantes por linhas

![Gráfico de barras do rank das 15 pastas](../Imagens/2026-04-14_21-10-56/rank_15_pastas_barras.png)

![Gráfico de pizza do rank das 15 pastas](../Imagens/2026-04-14_21-10-56/rank_15_pastas_pizza.png)

| Rank | Pasta | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `SimuladorServerJogo/Gerais` | `SimuladorServerJogo/Gerais` | 4 | 37 | 6.002 | 323.92 |
| 2 | `Telas` | `Codigo/Telas` | 1 | 18 | 5.309 | 208.55 |
| 3 | `Paineis` | `Codigo/Paineis` | 0 | 15 | 5.256 | 221.84 |
| 4 | `Dados` | `Dados` | 3 | 37 | 5.188 | 266.94 |
| 5 | `Outros` | `Outros` | 0 | 7 | 4.846 | 192.73 |
| 6 | `Geradores` | `Codigo/Geradores` | 1 | 16 | 3.998 | 180.58 |
| 7 | `SimuladorServerJogo/Batalha` | `SimuladorServerJogo/Batalha` | 1 | 13 | 3.959 | 191.53 |
| 8 | `SimuladorServerJogo/Mundo` | `SimuladorServerJogo/Mundo` | 1 | 16 | 3.670 | 190.12 |
| 9 | `ModulosMundo` | `Codigo/ModulosMundo` | 0 | 12 | 3.661 | 167.80 |
| 10 | `Prefabs` | `Codigo/Prefabs` | 0 | 14 | 3.327 | 120.13 |
| 11 | `ModulosGerais` | `Codigo/ModulosGerais` | 0 | 12 | 3.243 | 120.70 |
| 12 | `ModulosBatalha` | `Codigo/ModulosBatalha` | 0 | 10 | 3.076 | 140.57 |
| 13 | `SimuladorServerJogo/Logica` | `SimuladorServerJogo/Logica` | 3 | 20 | 2.765 | 82.46 |
| 14 | `Cenas` | `Codigo/Cenas` | 0 | 6 | 969 | 42.89 |
| 15 | `Server` | `Codigo/Server` | 0 | 4 | 405 | 14.73 |
...
| `SimuladorServerJogo/Batalha/LeitorJogadas.py` | 1.538 | 84.04 |
...
| `SimuladorServerJogo/Gerais/Geradores/GeradorMundo.py` | 573 | 21.63 |
...
| `SimuladorServerJogo/Gerais/Rotas/Atualizador.py` | 536 | 25.77 |
...
| `Codigo/Cenas/CenaMundo.py` | 418 | 21.92 |
...
| `SimuladorServerJogo/Batalha/SimuladorFisica.py` | 368 | 16.57 |
| `SimuladorServerJogo/Batalha/SistemaBatalha.py` | 366 | 16.43 |

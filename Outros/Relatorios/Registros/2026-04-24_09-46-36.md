...
- **Pastas:** 1.252
- **Arquivos:** 72.112
- **Arquivos de texto:** 206
- **Peso dos arquivos de texto:** 2365.73 KB
- **Tamanho total:** 0.568 GB (609.939.112 bytes)
- **Dias desde a criação do repo:** 53
- **Dias desde a criação oficial:** 327
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 57.261
- **Commits (repo):** 407
...
- **Arquivos `.py`:** 146
- **Linhas totais:** 40.443
- **Tamanho total `.py`:** 1706.33 KB
- **Classes encontradas:** 135
- **Funções encontradas:** 534
- **Métodos encontrados:** 1.745
- **Total funções + métodos:** 2.279
- **Bibliotecas diferentes usadas:** 43

## Rank das 15 pastas mais relevantes por linhas

![Gráfico de barras do rank das 15 pastas](../Imagens/2026-04-24_09-46-36/rank_15_pastas_barras.png)

![Gráfico de pizza do rank das 15 pastas](../Imagens/2026-04-24_09-46-36/rank_15_pastas_pizza.png)

| Rank | Pasta | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---:|---:|---:|---:|
| 1 | `ServerGerais` | 4 | 48 | 7.766 | 437.36 |
| 2 | `Paineis` | 0 | 16 | 6.038 | 259.72 |
| 3 | `Telas` | 1 | 19 | 5.733 | 228.38 |
| 4 | `Dados` | 3 | 36 | 4.779 | 259.85 |
| 5 | `ModulosMundo` | 0 | 14 | 4.203 | 191.87 |
| 6 | `ServerMundo` | 1 | 16 | 3.814 | 198.70 |
| 7 | `Prefabs` | 0 | 14 | 3.597 | 131.11 |
| 8 | `Geradores` | 1 | 15 | 3.414 | 151.03 |
| 9 | `ModulosGerais` | 0 | 15 | 3.242 | 120.61 |
| 10 | `Outros` | 0 | 5 | 3.213 | 114.85 |
| 11 | `ServerLogica` | 3 | 21 | 2.920 | 86.58 |
| 12 | `Cenas` | 0 | 6 | 1.290 | 59.65 |
| 13 | `Server` | 0 | 5 | 433 | 15.84 |
| 14 | `ModulosBatalha` | 0 | 2 | 193 | 8.37 |
...
| `SimuladorServerJogo/Gerais/Rotas/Atualizador.py` | 552 | 26.88 |
...
|---|---:|---:|---:|
| Arquivos | 72.144 | 72.112 | -32 |
| Linhas | 70.895 | 57.261 | -13.634 |
| Linhas .py | 52.667 | 40.443 | -12.224 |
| Métodos/funções | 2.934 | 2.279 | -655 |
| Classes | 176 | 135 | -41 |
| Commits | 404 | 407 | +3 |
| Tamanho | 582.27 MB | 581.68 MB | -605.86 KB |

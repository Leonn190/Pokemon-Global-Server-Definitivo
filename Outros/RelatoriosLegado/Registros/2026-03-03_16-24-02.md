...
**Relatório:** #2  
**Repo:** `relatorio_rebuild_t__3090c`  
**Gerado em:** 2026-04-13T22:36:49-03:00  
...
- **Peso dos arquivos de texto:** 128.95 KB
- **Tamanho total:** 0.094 GB (100.786.130 bytes)
- **Dias desde a criação do repo:** 1
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 3.924
- **Commits (repo):** 26
...
- **Arquivos `.py`:** 78
- **Linhas totais:** 3.924
- **Tamanho total `.py`:** 128.95 KB
- **Classes encontradas:** 14
- **Funções encontradas:** 106
- **Métodos encontrados:** 77
- **Total funções + métodos:** 183
...
| 2 | `Telas` | `Codigo/Telas` | 1 | 14 | 986 | 31.15 |
| 3 | `Prefabs` | `Codigo/Prefabs` | 0 | 10 | 895 | 31.09 |
| 4 | `Cenas` | `Codigo/Cenas` | 0 | 7 | 205 | 5.85 |
| 5 | `Server` | `Codigo/Server` | 0 | 4 | 23 | 0.58 |

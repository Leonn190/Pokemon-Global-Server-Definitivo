...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_3dr2ycmm`  
**Gerado em:** 2026-04-23T18:54:03  
...
- **Peso dos arquivos de texto:** 982.15 KB
- **Tamanho total:** 0.365 GB (391.875.423 bytes)
- **Dias desde a criação do repo:** 4
- **Dias desde a criação oficial:** 278
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 10.838
- **Commits (repo):** 86

## Python

- **Arquivos `.py`:** 98
- **Linhas totais:** 10.837
- **Tamanho total `.py`:** 380.38 KB
- **Classes encontradas:** 55
- **Funções encontradas:** 216
- **Métodos encontrados:** 358
- **Total funções + métodos:** 574

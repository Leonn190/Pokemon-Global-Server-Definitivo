...
**Relatório:** #9  
**Repo:** `relatorio_rebuild_00axm4uh`  
**Gerado em:** 2026-04-13T22:43:16-03:00  
...
- **Peso dos arquivos de texto:** 978.64 KB
- **Tamanho total:** 0.365 GB (391.871.824 bytes)
- **Dias desde a criação do repo:** 5
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 10.741
- **Commits (repo):** 89

## Python

- **Arquivos `.py`:** 98
- **Linhas totais:** 10.740
- **Tamanho total `.py`:** 376.86 KB
- **Classes encontradas:** 56
- **Funções encontradas:** 203
- **Métodos encontrados:** 367
- **Total funções + métodos:** 570
- **Bibliotecas diferentes usadas:** 24

## Rank das 15 pastas mais relevantes por linhas

![Gráfico de barras do rank das 15 pastas](Imagens/2026-03-07_01-12-40/rank_15_pastas_barras.png)

![Gráfico de pizza do rank das 15 pastas](Imagens/2026-03-07_01-12-40/rank_15_pastas_pizza.png)
...
| 4 | `Geradores` | `Codigo/Geradores` | 0 | 13 | 723 | 24.38 |
| 5 | `Cenas` | `Codigo/Cenas` | 0 | 7 | 508 | 17.61 |

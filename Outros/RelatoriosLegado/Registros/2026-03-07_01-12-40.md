...
**Relatório:** #1  
**Repo:** `relatorio_rebuild__85urrck`  
**Gerado em:** 2026-04-23T18:55:22  
...
- **Peso dos arquivos de texto:** 992.28 KB
- **Tamanho total:** 0.365 GB (391.885.793 bytes)
- **Dias desde a criação do repo:** 5
- **Dias desde a criação oficial:** 279
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 11.070
- **Commits (repo):** 89

## Python

- **Arquivos `.py`:** 98
- **Linhas totais:** 11.069
- **Tamanho total `.py`:** 390.50 KB
- **Classes encontradas:** 56
- **Funções encontradas:** 216
- **Métodos encontrados:** 367
- **Total funções + métodos:** 583

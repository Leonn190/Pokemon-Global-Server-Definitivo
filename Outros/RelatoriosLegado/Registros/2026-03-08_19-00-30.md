...
**Relatório:** #12  
**Repo:** `relatorio_rebuild_aoq9rspq`  
**Gerado em:** 2026-04-13T22:46:57-03:00  
...
- **Peso dos arquivos de texto:** 654.50 KB
- **Tamanho total:** 0.367 GB (394.527.257 bytes)
- **Dias desde a criação do repo:** 6
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 15.488
- **Commits (repo):** 116

## Python

- **Arquivos `.py`:** 95
- **Linhas totais:** 12.594
- **Tamanho total `.py`:** 451.93 KB
- **Classes encontradas:** 60
- **Funções encontradas:** 222
- **Métodos encontrados:** 431
- **Total funções + métodos:** 653
...
|---:|---|---|---:|---:|---:|---:|
| 1 | `Telas` | `Codigo/Telas` | 1 | 14 | 2.567 | 86.35 |
| 2 | `Outros` | `Outros` | 0 | 3 | 1.736 | 59.27 |
| 3 | `Prefabs` | `Codigo/Prefabs` | 0 | 11 | 1.460 | 51.75 |
| 4 | `Geradores` | `Codigo/Geradores` | 1 | 17 | 1.431 | 50.24 |
| 5 | `Dados` | `Dados` | 0 | 2 | 1.323 | 139.23 |
| 6 | `Cenas` | `Codigo/Cenas` | 0 | 7 | 550 | 19.52 |
| 7 | `Server` | `Codigo/Server` | 0 | 4 | 214 | 6.56 |
...
| `SimuladorServerJogo/Ativador.py` | `processar_ativador_json` | funcao | 71 |

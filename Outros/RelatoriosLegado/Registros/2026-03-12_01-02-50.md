...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_du0ykai2`  
**Gerado em:** 2026-04-23T19:04:19  
...
- **Peso dos arquivos de texto:** 843.47 KB
- **Tamanho total:** 0.378 GB (405.637.951 bytes)
- **Dias desde a criação do repo:** 10
- **Dias desde a criação oficial:** 284
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 19.528
- **Commits (repo):** 148

## Python

- **Arquivos `.py`:** 116
- **Linhas totais:** 16.564
- **Tamanho total `.py`:** 638.46 KB
- **Classes encontradas:** 67
- **Funções encontradas:** 295
- **Métodos encontrados:** 600
- **Total funções + métodos:** 895

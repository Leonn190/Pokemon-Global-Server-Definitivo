...
**Relatório:** #16  
**Repo:** `relatorio_rebuild_9uuxwmwt`  
**Gerado em:** 2026-04-13T22:51:29-03:00  
...
- **Peso dos arquivos de texto:** 946.71 KB
- **Tamanho total:** 0.378 GB (405.743.667 bytes)
- **Dias desde a criação do repo:** 10
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 21.854
- **Commits (repo):** 160

## Python

- **Arquivos `.py`:** 119
- **Linhas totais:** 17.078
- **Tamanho total `.py`:** 672.85 KB
- **Classes encontradas:** 74
- **Funções encontradas:** 283
- **Métodos encontrados:** 639
- **Total funções + métodos:** 922
- **Bibliotecas diferentes usadas:** 27

## Rank das 15 pastas mais relevantes por linhas

![Gráfico de barras do rank das 15 pastas](Imagens/2026-03-12_21-50-15/rank_15_pastas_barras.png)

![Gráfico de pizza do rank das 15 pastas](Imagens/2026-03-12_21-50-15/rank_15_pastas_pizza.png)

| Rank | Pasta | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `Telas` | `Codigo/Telas` | 1 | 14 | 2.887 | 99.60 |
| 2 | `Geradores` | `Codigo/Geradores` | 2 | 20 | 2.102 | 90.37 |
...
| 7 | `SimuladorServerJogo/Logica` | `SimuladorServerJogo/Logica` | 0 | 3 | 351 | 16.36 |
...
| `SimuladorServerJogo/Controle/CerebroProjeteis.py` | 122 | 6.69 |

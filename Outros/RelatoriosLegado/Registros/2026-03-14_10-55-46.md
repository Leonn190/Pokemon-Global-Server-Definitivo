...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_kw8b9wty`  
**Gerado em:** 2026-04-23T19:06:58  
...
- **Peso dos arquivos de texto:** 989.00 KB
- **Tamanho total:** 0.378 GB (405.786.970 bytes)
- **Dias desde a criação do repo:** 12
- **Dias desde a criação oficial:** 286
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 22.881
- **Commits (repo):** 165

## Python

- **Arquivos `.py`:** 115
- **Linhas totais:** 18.097
- **Tamanho total `.py`:** 715.00 KB
- **Classes encontradas:** 77
- **Funções encontradas:** 303
- **Métodos encontrados:** 692
- **Total funções + métodos:** 995

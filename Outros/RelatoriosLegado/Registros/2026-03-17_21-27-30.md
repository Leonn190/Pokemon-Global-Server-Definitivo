...
**Relatório:** #18  
**Repo:** `relatorio_rebuild_x7ifctsj`  
**Gerado em:** 2026-04-13T22:53:42-03:00  
...
- **Peso dos arquivos de texto:** 1070.53 KB
- **Tamanho total:** 0.378 GB (405.906.463 bytes)
- **Dias desde a criação do repo:** 15
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 25.643
- **Commits (repo):** 171

## Python

- **Arquivos `.py`:** 117
- **Linhas totais:** 19.078
- **Tamanho total `.py`:** 750.66 KB
- **Classes encontradas:** 79
- **Funções encontradas:** 290
- **Métodos encontrados:** 773
- **Total funções + métodos:** 1.063
- **Bibliotecas diferentes usadas:** 28

## Rank das 15 pastas mais relevantes por linhas

![Gráfico de barras do rank das 15 pastas](Imagens/2026-03-17_21-27-30/rank_15_pastas_barras.png)

![Gráfico de pizza do rank das 15 pastas](Imagens/2026-03-17_21-27-30/rank_15_pastas_pizza.png)

| Rank | Pasta | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `Telas` | `Codigo/Telas` | 1 | 15 | 3.331 | 118.83 |
| 2 | `Geradores` | `Codigo/Geradores` | 1 | 16 | 2.301 | 98.21 |
| 3 | `Prefabs` | `Codigo/Prefabs` | 0 | 12 | 2.010 | 69.33 |
| 4 | `Outros` | `Outros` | 0 | 3 | 1.751 | 59.71 |
| 5 | `Paineis` | `Codigo/Paineis` | 0 | 10 | 1.444 | 53.70 |
| 6 | `Dados` | `Dados` | 0 | 4 | 1.372 | 141.06 |

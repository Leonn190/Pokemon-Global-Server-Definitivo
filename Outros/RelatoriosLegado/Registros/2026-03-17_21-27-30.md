...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_fhe2oje1`  
**Gerado em:** 2026-04-23T19:08:13  
...
- **Peso dos arquivos de texto:** 1084.17 KB
- **Tamanho total:** 0.378 GB (405.920.432 bytes)
- **Dias desde a criação do repo:** 15
- **Dias desde a criação oficial:** 289
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 25.972
- **Commits (repo):** 171

## Python

- **Arquivos `.py`:** 117
- **Linhas totais:** 19.407
- **Tamanho total `.py`:** 764.30 KB
- **Classes encontradas:** 79
- **Funções encontradas:** 303
- **Métodos encontrados:** 773
- **Total funções + métodos:** 1.076

...
**Relatório:** #19  
**Repo:** `relatorio_rebuild_wkmab334`  
**Gerado em:** 2026-04-13T22:54:49-03:00  
...
- **Peso dos arquivos de texto:** 1095.73 KB
- **Tamanho total:** 0.379 GB (406.651.351 bytes)
- **Dias desde a criação do repo:** 17
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 26.262
- **Commits (repo):** 178

## Python

- **Arquivos `.py`:** 116
- **Linhas totais:** 19.433
- **Tamanho total `.py`:** 767.74 KB
- **Classes encontradas:** 78
- **Funções encontradas:** 293
- **Métodos encontrados:** 788
- **Total funções + métodos:** 1.081
...
| 2 | `Geradores` | `Codigo/Geradores` | 1 | 16 | 2.189 | 96.56 |
...
| 7 | `Cenas` | `Codigo/Cenas` | 0 | 7 | 470 | 16.53 |
| 8 | `SimuladorServerJogo/Logica` | `SimuladorServerJogo/Logica` | 0 | 3 | 351 | 16.36 |
| 9 | `Server` | `Codigo/Server` | 0 | 4 | 303 | 10.94 |

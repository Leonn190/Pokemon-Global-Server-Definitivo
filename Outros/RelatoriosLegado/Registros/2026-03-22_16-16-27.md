...
**Relatório:** #20  
**Repo:** `relatorio_rebuild_eiwgtp2r`  
**Gerado em:** 2026-04-13T22:55:57-03:00  
...
- **Peso dos arquivos de texto:** 1122.68 KB
- **Tamanho total:** 0.380 GB (407.873.483 bytes)
- **Dias desde a criação do repo:** 20
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 26.921
- **Commits (repo):** 186

## Python

- **Arquivos `.py`:** 117
- **Linhas totais:** 20.092
- **Tamanho total `.py`:** 794.71 KB
- **Classes encontradas:** 83
- **Funções encontradas:** 300
- **Métodos encontrados:** 811
- **Total funções + métodos:** 1.111
- **Bibliotecas diferentes usadas:** 28

## Rank das 15 pastas mais relevantes por linhas

![Gráfico de barras do rank das 15 pastas](Imagens/2026-03-22_16-16-27/rank_15_pastas_barras.png)

![Gráfico de pizza do rank das 15 pastas](Imagens/2026-03-22_16-16-27/rank_15_pastas_pizza.png)

| Rank | Pasta | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `Telas` | `Codigo/Telas` | 1 | 15 | 3.331 | 118.83 |
| 2 | `Geradores` | `Codigo/Geradores` | 1 | 16 | 2.303 | 101.15 |
| 3 | `Prefabs` | `Codigo/Prefabs` | 0 | 12 | 2.010 | 69.33 |
| 4 | `Outros` | `Outros` | 0 | 3 | 1.751 | 59.71 |
| 5 | `Paineis` | `Codigo/Paineis` | 0 | 10 | 1.603 | 56.76 |

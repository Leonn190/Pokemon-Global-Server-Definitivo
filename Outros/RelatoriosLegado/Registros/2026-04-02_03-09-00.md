...
**Relatório:** #23  
**Repo:** `relatorio_rebuild_uvx0yi8b`  
**Gerado em:** 2026-04-13T22:59:31-03:00  
...
- **Peso dos arquivos de texto:** 1352.81 KB
- **Tamanho total:** 0.398 GB (427.738.837 bytes)
- **Dias desde a criação do repo:** 31
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 31.995
- **Commits (repo):** 226

## Python

- **Arquivos `.py`:** 123
- **Linhas totais:** 25.014
- **Tamanho total `.py`:** 1012.32 KB
- **Classes encontradas:** 92
- **Funções encontradas:** 333
- **Métodos encontrados:** 1.081
- **Total funções + métodos:** 1.414
- **Bibliotecas diferentes usadas:** 37

## Rank das 15 pastas mais relevantes por linhas

![Gráfico de barras do rank das 15 pastas](Imagens/2026-04-02_03-09-00/rank_15_pastas_barras.png)

![Gráfico de pizza do rank das 15 pastas](Imagens/2026-04-02_03-09-00/rank_15_pastas_pizza.png)

| Rank | Pasta | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `Telas` | `Codigo/Telas` | 1 | 15 | 4.368 | 168.14 |
| 2 | `Paineis` | `Codigo/Paineis` | 0 | 13 | 4.022 | 164.42 |
| 3 | `Prefabs` | `Codigo/Prefabs` | 0 | 14 | 2.707 | 96.25 |
| 4 | `Geradores` | `Codigo/Geradores` | 1 | 16 | 2.534 | 112.76 |
| 5 | `Outros` | `Outros` | 0 | 3 | 1.751 | 59.71 |
| 6 | `Dados` | `Dados` | 0 | 6 | 1.625 | 157.55 |
...
| `Codigo/Telas/Inventario/InventarioPokemons.py` | `InventarioPokemons._soltar_no_alvo` | metodo | 83 |
...
| `SimuladorServerJogo/Controle/EstadoServidor.py` | `.py` | 540 |

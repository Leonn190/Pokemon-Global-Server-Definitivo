...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_jq0n7mo5`  
**Gerado em:** 2026-04-23T19:17:14  
...
- **Peso dos arquivos de texto:** 1512.40 KB
- **Tamanho total:** 0.404 GB (433.948.483 bytes)
- **Dias desde a criação do repo:** 33
- **Dias desde a criação oficial:** 307
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 35.772
- **Commits (repo):** 257

## Python

- **Arquivos `.py`:** 128
- **Linhas totais:** 28.111
- **Tamanho total `.py`:** 1154.84 KB
- **Classes encontradas:** 101
- **Funções encontradas:** 355
- **Métodos encontrados:** 1.209
- **Total funções + métodos:** 1.564

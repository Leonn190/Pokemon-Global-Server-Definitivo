...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_auzfax47`  
**Gerado em:** 2026-04-23T19:23:46  
...
- **Peso dos arquivos de texto:** 1836.20 KB
- **Tamanho total:** 0.404 GB (433.617.557 bytes)
- **Dias desde a criação do repo:** 38
- **Dias desde a criação oficial:** 312
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 42.998
- **Commits (repo):** 305

## Python

- **Arquivos `.py`:** 136
- **Linhas totais:** 34.465
- **Tamanho total `.py`:** 1444.24 KB
- **Classes encontradas:** 124
- **Funções encontradas:** 411
- **Métodos encontrados:** 1.548
- **Total funções + métodos:** 1.959

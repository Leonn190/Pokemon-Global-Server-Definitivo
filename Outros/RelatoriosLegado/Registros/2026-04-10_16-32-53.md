...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_gmjmncpx`  
**Gerado em:** 2026-04-23T19:25:11  
...
- **Peso dos arquivos de texto:** 1896.97 KB
- **Tamanho total:** 0.404 GB (433.683.440 bytes)
- **Dias desde a criação do repo:** 39
- **Dias desde a criação oficial:** 313
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 44.329
- **Commits (repo):** 309

## Python

- **Arquivos `.py`:** 140
- **Linhas totais:** 35.792
- **Tamanho total `.py`:** 1504.69 KB
- **Classes encontradas:** 130
- **Funções encontradas:** 415
- **Métodos encontrados:** 1.622
- **Total funções + métodos:** 2.037

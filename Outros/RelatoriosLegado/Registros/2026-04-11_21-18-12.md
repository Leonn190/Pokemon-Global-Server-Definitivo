...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_7f3rjod5`  
**Gerado em:** 2026-04-23T19:26:26  
...
- **Peso dos arquivos de texto:** 2080.46 KB
- **Tamanho total:** 0.444 GB (477.241.751 bytes)
- **Dias desde a criação do repo:** 40
- **Dias desde a criação oficial:** 314
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 48.317
- **Commits (repo):** 320

## Python

- **Arquivos `.py`:** 148
- **Linhas totais:** 39.672
- **Tamanho total `.py`:** 1682.88 KB
- **Classes encontradas:** 141
- **Funções encontradas:** 436
- **Métodos encontrados:** 1.827
- **Total funções + métodos:** 2.263
...
| 3 | `Dados` | 3 | 36 | 4.789 | 251.31 |
| 4 | `Outros` | 0 | 5 | 4.445 | 178.16 |
...
| 11 | `Server` | 0 | 5 | 405 | 14.69 |
| 12 | `ServerLogica` | 0 | 3 | 251 | 12.39 |
| 13 | `ServerBatalha` | 0 | 4 | 101 | 4.16 |

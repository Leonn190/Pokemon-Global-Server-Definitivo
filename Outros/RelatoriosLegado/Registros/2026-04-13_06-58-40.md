...
**Relatório:** #1  
**Repo:** `relatorio_rebuild_orhjzgk2`  
**Gerado em:** 2026-04-23T19:30:39  
...
- **Peso dos arquivos de texto:** 2411.16 KB
- **Tamanho total:** 0.541 GB (581.151.953 bytes)
- **Dias desde a criação do repo:** 42
- **Dias desde a criação oficial:** 316
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 55.841
- **Commits (repo):** 333

## Python

- **Arquivos `.py`:** 164
- **Linhas totais:** 46.797
- **Tamanho total `.py`:** 1996.62 KB
- **Classes encontradas:** 158
- **Funções encontradas:** 571
- **Métodos encontrados:** 2.037
- **Total funções + métodos:** 2.608

...
**Gerado em:** 2026-04-14T06:49:33-03:00  
...
- **Peso dos arquivos de texto:** 2403.42 KB
- **Tamanho total:** 0.541 GB (581.246.843 bytes)
- **Dias desde a criação do repo:** 43
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 55.448
- **Commits (repo):** 343

## Python

- **Arquivos `.py`:** 163
- **Linhas totais:** 46.388
- **Tamanho total `.py`:** 1989.85 KB
- **Classes encontradas:** 160
- **Funções encontradas:** 510
- **Métodos encontrados:** 2.114
- **Total funções + métodos:** 2.624
- **Bibliotecas diferentes usadas:** 43

## Rank das 15 pastas mais relevantes por linhas

![Gráfico de barras do rank das 15 pastas](../Imagens/2026-04-14_06-49-33/rank_15_pastas_barras.png)

![Gráfico de pizza do rank das 15 pastas](../Imagens/2026-04-14_06-49-33/rank_15_pastas_pizza.png)

| Rank | Pasta | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `SimuladorServerJogo/Gerais` | `SimuladorServerJogo/Gerais` | 3 | 25 | 6.240 | 356.43 |
...
| 6 | `Geradores` | `Codigo/Geradores` | 1 | 16 | 3.974 | 178.85 |
| 7 | `SimuladorServerJogo/Batalha` | `SimuladorServerJogo/Batalha` | 1 | 13 | 3.959 | 191.53 |
| 8 | `ModulosMundo` | `Codigo/ModulosMundo` | 0 | 12 | 3.651 | 167.30 |
| 9 | `SimuladorServerJogo/Mundo` | `SimuladorServerJogo/Mundo` | 1 | 16 | 3.637 | 188.75 |
| 10 | `Prefabs` | `Codigo/Prefabs` | 0 | 15 | 3.329 | 120.14 |
| 11 | `ModulosGerais` | `Codigo/ModulosGerais` | 0 | 12 | 3.243 | 120.70 |
| 12 | `ModulosBatalha` | `Codigo/ModulosBatalha` | 0 | 10 | 3.057 | 139.67 |
| 13 | `SimuladorServerJogo/Logica` | `SimuladorServerJogo/Logica` | 3 | 18 | 2.254 | 73.80 |
...
| `SimuladorServerJogo/Gerais/Rotas/Atualizador.py` | 536 | 25.72 |
...
| `SimuladorServerJogo/Gerais/Geradores/GeradorMundo.py` | 471 | 18.58 |

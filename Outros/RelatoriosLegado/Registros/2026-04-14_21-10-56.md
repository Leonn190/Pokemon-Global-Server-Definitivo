...
**Relatório:** #37  
**Repo:** `relatorio_rebuild_itty2tud`  
**Gerado em:** 2026-04-23T19:33:26  
...
- **Peso dos arquivos de texto:** 2408.90 KB
- **Tamanho total:** 0.549 GB (589.752.695 bytes)
- **Dias desde a criação do repo:** 43
- **Dias desde a criação oficial:** 317
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 56.125
- **Commits (repo):** 348
...
- **Arquivos `.py`:** 162
- **Linhas totais:** 46.894
- **Tamanho total `.py`:** 2014.37 KB
- **Classes encontradas:** 160
- **Funções encontradas:** 526
- **Métodos encontrados:** 2.122
- **Total funções + métodos:** 2.648
...
| 3 | `Paineis` | 0 | 15 | 5.256 | 221.84 |
| 4 | `Dados` | 3 | 37 | 5.188 | 268.27 |
...
|---|---:|---:|---:|
| Arquivos | 72.059 | 72.077 | +18 |
| Linhas | 55.448 | 56.125 | +677 |
| Linhas .py | 46.388 | 46.894 | +506 |
| Métodos/funções | 2.624 | 2.648 | +24 |
| Classes | 160 | 160 | 0 |
| Commits | 343 | 348 | +5 |
| Tamanho | 554.32 MB | 562.43 MB | +8.11 MB |

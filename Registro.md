...
**Gerado em:** 2026-04-21T05:37:12-03:00  
...
- **Peso dos arquivos de texto:** 2703.72 KB
- **Tamanho total:** 0.568 GB (610.285.397 bytes)
- **Dias desde a criação do repo:** 50
- **Horas estimadas:** 313.00
- **Linhas totais gerais:** 62.624
- **Commits (repo):** 385

## Python

- **Arquivos `.py`:** 173
- **Linhas totais:** 51.883
- **Tamanho total `.py`:** 2245.14 KB
- **Classes encontradas:** 173
- **Funções encontradas:** 565
- **Métodos encontrados:** 2.342
- **Total funções + métodos:** 2.907
- **Bibliotecas diferentes usadas:** 43

## Rank das 15 pastas mais relevantes por linhas

![Gráfico de barras do rank das 15 pastas](Outros/Relatorios/Imagens/2026-04-21_05-37-12/rank_15_pastas_barras.png)

![Gráfico de pizza do rank das 15 pastas](Outros/Relatorios/Imagens/2026-04-21_05-37-12/rank_15_pastas_pizza.png)

| Rank | Pasta | Caminho | Subpastas | Arquivos | Linhas gerais | Tamanho (KB) |
|---:|---|---|---:|---:|---:|---:|
| 1 | `SimuladorServerJogo/Gerais` | `SimuladorServerJogo/Gerais` | 4 | 48 | 7.778 | 437.80 |
...
| 6 | `SimuladorServerJogo/Batalha` | `SimuladorServerJogo/Batalha` | 1 | 13 | 4.336 | 208.63 |
| 7 | `ModulosMundo` | `Codigo/ModulosMundo` | 0 | 14 | 4.203 | 191.30 |
| 8 | `Geradores` | `Codigo/Geradores` | 1 | 16 | 4.061 | 182.56 |
| 9 | `ModulosBatalha` | `Codigo/ModulosBatalha` | 0 | 12 | 4.059 | 186.92 |
| 10 | `ModulosGerais` | `Codigo/ModulosGerais` | 0 | 15 | 3.941 | 149.99 |
| 11 | `SimuladorServerJogo/Mundo` | `SimuladorServerJogo/Mundo` | 1 | 16 | 3.814 | 198.58 |
| 12 | `Prefabs` | `Codigo/Prefabs` | 0 | 14 | 3.597 | 131.39 |
| 13 | `SimuladorServerJogo/Logica` | `SimuladorServerJogo/Logica` | 3 | 22 | 3.178 | 97.64 |
...
![Gráfico de pizza das linhas por extensão](Outros/Relatorios/Imagens/2026-04-21_05-37-12/linhas_por_extensao_pizza.png)
...
![Crescimento de linhas gerais](Outros/Relatorios/Imagens/2026-04-21_05-37-12/crescimento_linhas_totais.png)

![Crescimento de linhas .py](Outros/Relatorios/Imagens/2026-04-21_05-37-12/crescimento_linhas_py.png)

![Crescimento de arquivos .py](Outros/Relatorios/Imagens/2026-04-21_05-37-12/crescimento_arquivos_py.png)

![Crescimento de commits](Outros/Relatorios/Imagens/2026-04-21_05-37-12/crescimento_commits.png)

...
from Servidor.Batalha.CalculoDanoBatalha import aplicar_dano
...
class PokemonBatalha:
    ...
    def _coletar_ataques(bruto: dict, info: dict, estado: dict) -> list:
        ...
        try:
            from Servidor.Gerais.Geradores.GeradorPokemon import normalizar_habilidades_memorias
    ...
    def AplicarDano(self, alvo, dados_dano, contexto=None):
        return aplicar_dano(self, alvo, dados_dano, contexto)

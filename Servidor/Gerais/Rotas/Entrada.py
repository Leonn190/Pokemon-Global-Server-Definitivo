...
from Servidor.Gerais.Rotas.Ativador import registrar_diff, desconectar_client
from Servidor.Mundo.BancoDados import BANCO_DADOS
from Servidor.Gerais.EstadoServidor import adicionar_personagem, obter_personagem_para_entrada, snapshot_estado, obter_regras_cliente, registrar_checkpoint_mundo_seguro, aplicar_invulnerabilidade_player
from Servidor.Mundo.Dungeons.EstadoDungeon import normalizar_personagem_login_dungeon

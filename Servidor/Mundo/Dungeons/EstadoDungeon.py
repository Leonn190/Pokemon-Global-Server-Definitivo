...
from Servidor.Gerais.EstadoServidor import obter_personagem_para_entrada, atualizar_perfil_personagem, resolver_respawn_mundo_seguro
...
def normalizar_personagem_login_dungeon(usuario: str, personagem: dict) -> dict:
    ...
    try:
        from Servidor.Gerais.EstadoServidor import atualizar_posicao_personagem

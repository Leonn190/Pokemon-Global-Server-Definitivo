...
from Servidor.Gerais.LoaderTabelas import carregar_csv_dict, carregar_csv_lista, caminho_tabela
from typing import Dict, List, Tuple

from Servidor.Gerais.Geradores.GeradorPokemon import criar_pokemon_inicial_materializado, subir_nivel_pokemon

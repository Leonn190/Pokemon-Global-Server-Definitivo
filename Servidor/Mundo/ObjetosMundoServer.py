...
from Servidor.Mundo.EstadioGeometria import offset_porta_externa
from Servidor.Mundo.Colisor import Colisor
from Servidor.Gerais.LoaderRegras import carregar_regras_pokemons
from Servidor.Mundo.AutoridadeCaptura import resolver_captura, resolver_fruta
...
class EstadioServer:
    def __init__(self, id_objeto: int, tipo_estadio: str, dimensao: str, posicao: Vector2 = (0.0, 0.0), raio_elipse_x: float = 24.0, raio_elipse_y: float = 24.0, raio_interacao: float = 2.5):
        ...
        self.estado_extra = {
            ...
            "spawn_interno_pos": spawn_interno,
            "arena_centro": [largura_interna * 0.5, altura_interna * 0.5],
        }
